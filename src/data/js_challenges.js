  ...
  JP: [
    {
      id: 'jp_js_1',
      title: '変数を宣言しよう (let)',
      description: '東京の人口を let で宣言してください。',
      code: '___BLANK___ population = 14000000;\nconsole.log(population);',
      blank: 'let',
      hint: '再代入できる変数は let、再代入不可は const',
      explanation: 'JavaScriptでは let で変数を宣言します。var は古い書き方で、let/const を使うのが現代的です。',
    },
    {
      id: 'jp_js_2',
      title: '定数を宣言しよう (const)',
      description: '変わらない首都名を const で宣言してください。',
      code: '___BLANK___ capital = "Tokyo";\nconsole.log(capital);',
      blank: 'const',
      hint: '変わらない値には const を使います',
      explanation: 'const は再代入できない定数です。オブジェクトや配列は const でも中身を変えられます。',
    },
    {
      id: 'jp_js_3',
      title: 'テンプレートリテラルを使おう',
      description: '変数を文字列に埋め込む ${} を使ってください。',
      code: 'const city = "Tokyo";\nconst msg = `Capital: ${___BLANK___}`;\nconsole.log(msg);',
      blank: 'city',
      hint: '${変数名} の形で変数を埋め込みます',
      explanation: 'テンプレートリテラルはバッククォートで囲み、${変数名} で変数の値を埋め込めます。文字列連結より読みやすいです。',
    },
    {
      id: 'jp_js_4',
      title: 'typeof で型を調べよう',
      description: '変数の型を確認するキーワードを入れてください。',
      code: 'const country = "Japan";\nconsole.log(___BLANK___ country);',
      blank: 'typeof',
      hint: 'typeof は型名を文字列で返します',
      explanation: 'typeof 演算子で型を調べられます。"string"、"number"、"boolean"、"object" などを返します。',
    },
    {
      id: 'jp_js_5',
      title: '数値に変換しよう',
      description: '文字列 "42" を数値に変換してください。',
      code: 'const str = "42";\nconst num = ___BLANK___(str);\nconsole.log(num + 1);',
      blank: 'Number',
      hint: 'Number() で文字列を数値に変換できます',
      explanation: 'Number() で数値変換、String() で文字列変換、Boolean() で真偽値変換ができます。',
    },
    {
      id: 'jp_js_6',
      title: '厳密等値を使おう',
      description: 'JavaScriptでは === を使って型も含めて比較します。',
      code: 'console.log(42 ___BLANK___ "42");\n// false が出力される',
      blank: '===',
      hint: '=== は型も含めて比較します（== は型変換あり）',
      explanation: '=== は値と型が両方同じときだけ true。"42" は文字列、42 は数値なので false です。',
    },
  ],
