  ...
  "US": [
    {
      ...
      "description": "House of Representatives composition の公式データを使い、object-property の空欄を補います。",
    ...
    },
    {
      ...
      "description": "federal/state government structure の公式データを使い、nested-object の空欄を補います。",
    ...
    },
    {
      ...
      "description": "Statue of Liberty/France connection の公式データを使い、strict-equality の空欄を補います。",
    ...
    },
    {
      ...
      "description": "Liberty Bell inscription/symbolism の公式データを使い、string-includes の空欄を補います。",
    ...
    },
    {
      ...
      "description": "Yosemite World Heritage の公式データを使い、array-index の空欄を補います。",
    ...
    },
    {
      ...
      "description": "Mesa Verde cliff dwellings の公式データを使い、numeric-comparison の空欄を補います。",
    ...
    },
    {
      ...
      "description": "George Washington first presidency context の公式データを使い、template-literal の空欄を補います。",
    ...
    },
    {
      ...
      "description": "Ernest Hemingway Nobel Literature の公式データを使い、object-destructuring の空欄を補います。",
    ...
    },
    {
      ...
      "description": "Denali geographic elevation context の公式データを使い、Math.max/comparison の空欄を補います。",
    ...
    },
    {
      ...
      "description": "Golden Gate Bridge data の公式データを使い、Object.values の空欄を補います。",
