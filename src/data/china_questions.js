...
const jsExecute = [
  { id: 'cn_js_e01', languageId: 'javascript', world: 'execute', title: 'Tu Youyou', titleJa: 'トゥ・ヨウヨウ（屠呦呦）', category: 'science-history', objective: 'array', source: SRC.tuYouyou, summaryJa: 'トゥ・ヨウヨウは2015年にノーベル生理学・医学賞を受賞しました。', prompt: 'map と join の出力を選んでください。', code: 'const names = ["tu-youyou"];\nconst label = names.map(n => n.toUpperCase()).join("-");\nconsole.log(label);', options: ['TU-YOUYOU', 'tu-youyou', 'T-U', 'Tu-Youyou'], answer: 'TU-YOUYOU', expectedOutput: 'TU-YOUYOU', hint: '各要素を大文字化します。', explanation: 'tu-youyou が大文字になります。', programmingExplanation: 'map は各要素を変換し、join は配列を文字列にまとめます。', optionExplanations: { 'TU-YOUYOU': '正解。toUpperCase()でtu-youyouがすべて大文字になり、要素が1つなのでjoinの区切り文字は使われずTU-YOUYOUになります。', 'tu-youyou': 'toUpperCase()が適用されるため、小文字のままのtu-youyouが出力されることはありません。', 'T-U': 'namesの要素は"tu-youyou"という1つの文字列全体で、文字単位に分割されて区切られるわけではありません。', 'Tu-Youyou': 'toUpperCase()は文字列全体を大文字化するため、先頭だけが大文字になることはありません。' } },
