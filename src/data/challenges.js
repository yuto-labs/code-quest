    ...
    "python": [
      {
        ...
        "description": "天皇の憲法上の地位を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      ...
      },
      {
        ...
        "description": "国会の二院制を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        "hint": "空欄の前後を見て、どのキーまたは添字を使えば topic/note が取り出せるか確認します。",
      ...
      },
      {
        ...
        "description": "湯川秀樹とノーベル賞を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      ...
      },
      {
        ...
        "description": "日章旗・日の丸を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      ...
      },
      {
        ...
        "description": "47都道府県を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        "hint": "空欄の前後を見て、どのキーまたは添字を使えば topic/note が取り出せるか確認します。",
      ...
      },
      {
        ...
        "description": "一円硬貨を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        "hint": "空欄の前後を見て、どのキーまたは添字を使えば topic/note が取り出せるか確認します。",
      ...
      },
      {
        ...
        "description": "東海道新幹線を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        "hint": "空欄の前後を見て、どのキーまたは添字を使えば topic/note が取り出せるか確認します。",
      ...
      },
      {
        ...
        "description": "QRを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        "hint": "空欄の前後を見て、どのキーまたは添字を使えば topic/note が取り出せるか確認します。",
      ...
      },
      {
        ...
        "description": "法隆寺地域の仏教建造物を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        "hint": "空欄の前後を見て、どのキーまたは添字を使えば topic/note が取り出せるか確認します。",
      ...
      },
      {
        ...
        "description": "桜の文化的象徴性を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        "hint": "空欄の前後を見て、どのキーまたは添字を使えば topic/note が取り出せるか確認します。",
    ...
    "python": [
      {
        ...
        "description": "アメリカ連邦政府の三権を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        ...
        "programmingExplanation": "dict-access の構文を、実データ参照に使う練習です。",
      ...
      },
      {
        ...
        "description": "アメリカ上院を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        ...
        "programmingExplanation": "list-length/numeric の構文を、実データ参照に使う練習です。",
      ...
      },
      {
        ...
        "description": "アメリカ国旗を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      ...
      },
      {
        ...
        "description": "ハクトウワシを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        ...
        "programmingExplanation": "membership/boolean の構文を、実データ参照に使う練習です。",
      ...
      },
      {
        ...
        "description": "イエローストーン国立公園を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        ...
        "programmingExplanation": "tuple-unpack の構文を、実データ参照に使う練習です。",
      ...
      },
      {
        ...
        "description": "独立記念館を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        ...
        "programmingExplanation": "list-index の構文を、実データ参照に使う練習です。",
      ...
      },
      {
        ...
        "description": "アポロ11号を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        ...
        "programmingExplanation": "f-string の構文を、実データ参照に使う練習です。",
      ...
      },
      {
        ...
        "description": "マーク・トウェインを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        ...
        "programmingExplanation": "string/dict の構文を、実データ参照に使う練習です。",
      ...
      },
      {
        ...
        "description": "ミシシッピ川を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      ...
      },
      {
        ...
        "description": "ルート66を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        ...
        "programmingExplanation": "string-slice の構文を、実データ参照に使う練習です。",
