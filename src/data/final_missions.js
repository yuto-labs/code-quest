        ...
        "questions": [
          {
            ...
            "description": "大日本帝国憲法の公布を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
          ...
          },
          {
            ...
            "description": "大江健三郎とノーベル文学賞を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
            "hint": "`record` は辞書です。条件が True のときに表示したい記録名のキーを選びます。",
          ...
          },
          {
            ...
            "description": "金閣寺と鹿苑寺を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
            "hint": "`record` は辞書です。条件が True のときに表示したい記録名のキーを選びます。",
      ...
      "javascript": {
        ...
        "questions": [
          ...
          },
          {
            ...
            "description": "スーパーカミオカンデを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
            "hint": "`find` で残った object から、表示したい名前のプロパティを読みます。",
          ...
          },
          {
            ...
            "description": "厳島神社を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
            "hint": "`find` で残った object から、表示したい名前のプロパティを読みます。",
        ...
        "questions": [
          {
            ...
            "description": "権利章典を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
          ...
          },
          {
            ...
            "description": "トニ・モリスンを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
          ...
          },
          {
            ...
            "description": "アメリカ合衆国の国璽を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
        ...
        "questions": [
          {
            ...
            "description": "キング牧師とノーベル平和賞を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
          ...
          },
          {
            ...
            "description": "憲法修正第1条を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
          ...
          },
          {
            ...
            "description": "ラシュモア山を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
