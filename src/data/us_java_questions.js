...
function execute(questionId, conceptId, title, prompt, code, options, answer, hint, explanation, programmingExplanation, optionExplanations) {
...
function debugStep(stepNum, stepTitle, prompt, question, options, answer, hint, explanation, optionExplanations) {
  return { stepNum, stepTitle, prompt, question, options, answer, hint, explanation, optionExplanations };
}
...
export const US_JAVA_EXECUTE = [
  execute('us_java_e01', 'strings', 'Ellis Island: String.equals', 'Ellis Island の移民局データを String.equals で判定した出力を選んでください。', 'public class Main {\n    public static void main(String[] args) {\n        String site = "Ellis Island";\n        if (site.equals("Ellis Island")) {\n            System.out.println("opened:1892");\n        } else {\n            System.out.println("other");\n        }\n    }\n}', ['opened:1892', 'other', 'Ellis Island', 'true'], 'opened:1892', 'equals の比較結果が true のとき、最初の println が実行されます。', 'site の中身は "Ellis Island" なので equals は true になり、1892年のラベルが出力されます。', 'String.equals は文字列の内容比較を行います。', { 'opened:1892': '正解。site.equals("Ellis Island")はtrueになるため、if節のopened:1892が出力されます。', 'other': 'equalsによる文字列内容の比較はtrueになるため、else節のotherは実行されません。', 'Ellis Island': '出力されるのはif/elseで選ばれた固定文字列であり、site自体の値が出力されるわけではありません。', 'true': 'if文の条件式の評価結果ではなく、その分岐内で実行されるSystem.out.printlnの文字列が出力されます。' }),
  execute('us_java_e02', 'arrays', 'Appalachian Trail: array accumulation', 'アパラチアン・トレイルの州データを順に連結した出力を選んでください。', 'public class Main {\n    public static void main(String[] args) {\n        String[] states = {"Georgia", "North Carolina", "Maine"};\n        String route = "";\n        for (String state : states) {\n            route += state.substring(0, 2) + "-";\n        }\n        System.out.println(route.substring(0, route.length() - 1));\n    }\n}', ['Ge-No-Ma', 'GA-NC-ME', 'Georgia-North Carolina-Maine', 'Ma-No-Ge'], 'Ge-No-Ma', 'substring(0, 2) は先頭2文字です。', '各州名の先頭2文字を配列順に取り、末尾のハイフンだけを最後に削ります。', 'ループ、文字列連結、substring、length を組み合わせて出力を追跡します。', { 'Ge-No-Ma': '正解。substring(0,2)は各州名の先頭2文字（Ge,No,Ma）を取り、配列順に連結後、末尾の1文字（ハイフン）だけが削られます。', 'GA-NC-ME': 'これは州の略称であり、substring(0,2)が実際に取り出すのは元の州名の先頭2文字（Ge,No,Ma）です。', 'Georgia-North Carolina-Maine': 'substring(0,2)で各州名は先頭2文字に切り詰められており、州名全体が出力されることはありません。', 'Ma-No-Ge': '拡張forループはstatesの並び順（Georgiaが先）通りに処理するため、逆順になることはありません。' }),
  execute('us_java_e03', 'methods', 'World’s Columbian Exposition: method return', '1893年にChicagoで開催された博覧会ラベルを作るメソッドの出力を選んでください。', 'public class Main {\n    static String fairLabel(String city, int year) {\n        return city + ":" + year;\n    }\n    public static void main(String[] args) {\n        String label = fairLabel("Chicago", 1893);\n        System.out.println(label);\n    }\n}', ['Chicago:1893', '1893:Chicago', 'World Fair', 'Chicago'], 'Chicago:1893', 'return された文字列が label に入ります。', 'fairLabel("Chicago", 1893) は city と year をコロンで連結して返します。', 'メソッドの戻り値が変数へ入り、その値が println に渡されます。', { 'Chicago:1893': '正解。return city + ":" + yearはcityが先、yearが後に連結されるためこの順になります。', '1893:Chicago': 'return文の連結順はcityが先でyearが後であり、逆順にはなりません。', 'World Fair': 'fairLabelはcityとyearを連結した文字列を返すメソッドで、固定の"World Fair"という文字列を返すわけではありません。', 'Chicago': '戻り値にはyearの値も連結されているため、city文字列だけが出力されることはありません。' }),
  execute('us_java_e04', 'collections', 'Redwood parks: ArrayList filtering', '海岸レッドウッドを保護する parks データを条件で絞った出力を選んでください。', 'import java.util.ArrayList;\npublic class Main {\n    public static void main(String[] args) {\n        ArrayList<String> parks = new ArrayList<>();\n        parks.add("Redwood:coastal redwood");\n        parks.add("Desert:dry lands");\n        for (String park : parks) {\n            if (park.contains("coastal redwood")) {\n                System.out.println(park.split(":")[0]);\n            }\n        }\n    }\n}', ['Redwood', 'Desert', 'coastal redwood', 'Redwood:coastal redwood'], 'Redwood', 'contains の条件に合う要素だけが出力されます。', '1つ目だけが条件に合い、split(":")[0] によって名前部分だけが取り出されます。', 'ArrayList の走査、contains、split を順に追います。', { 'Redwood': '正解。"Redwood:coastal redwood"だけがcontains("coastal redwood")を満たし、split(":")[0]で名前部分のRedwoodが出力されます。', 'Desert': '"Desert:dry lands"にはcontains("coastal redwood")の条件を満たす文字列が含まれず、if文の中に入りません。', 'coastal redwood': 'split(":")[0]は":"より前の部分を取り出すため、出力されるのはRedwoodでcoastal redwoodではありません。', 'Redwood:coastal redwood': 'split(":")[0]によって":"の前の部分だけが取り出されるため、完全な文字列がそのまま出力されることはありません。' }),
  execute('us_java_e05', 'collections', 'Harlem Renaissance: HashMap lookup', 'ハーレム・ルネサンスの人物カテゴリを HashMap から取り出した出力を選んでください。', 'import java.util.HashMap;\npublic class Main {\n    public static void main(String[] args) {\n        HashMap<String, String> roles = new HashMap<>();\n        roles.put("Langston Hughes", "poet");\n        roles.put("Duke Ellington", "musician");\n        roles.put("Zora Neale Hurston", "writer");\n        System.out.println(roles.get("Duke Ellington"));\n    }\n}', ['musician', 'poet', 'writer', 'Duke Ellington'], 'musician', 'get に渡したキーに対応する値を探します。', 'キー "Duke Ellington" に対応して保存されている値は "musician" です。', 'HashMap はキーが完全一致したときだけ対応する値を返します。', { 'musician': '正解。roles.get("Duke Ellington")はキー"Duke Ellington"に対応する値"musician"を返します。', 'poet': 'これはキー"Langston Hughes"に対応する値で、"Duke Ellington"の値ではありません。', 'writer': 'これはキー"Zora Neale Hurston"に対応する値で、"Duke Ellington"の値ではありません。', 'Duke Ellington': 'これはキーの名前そのものであり、getはキーに対応する値を返します。' }),
  execute('us_java_e06', 'classes', 'Metropolitan Museum of Art: object fields', 'Metropolitan Museum of Art のオブジェクトを作った後の出力を選んでください。', 'class Museum {\n    String name;\n    int founded;\n    Museum(String name, int founded) {\n        this.name = name;\n        this.founded = founded;\n    }\n}\npublic class Main {\n    public static void main(String[] args) {\n        Museum met = new Museum("Met", 1870);\n        System.out.println(met.name + ":" + met.founded);\n    }\n}', ['Met:1870', '1870:Met', 'Metropolitan Museum of Art', 'Error'], 'Met:1870', 'コンストラクタ引数がフィールドに代入されます。', 'new Museum("Met", 1870) により name は Met、founded は1870になります。', 'オブジェクトのフィールド値をドットで取り出して連結します。', { 'Met:1870': '正解。met.name + ":" + met.foundedはnameが先、foundedが後に連結されるため、Met:1870になります。', '1870:Met': '連結式はmet.nameが先、met.foundedが後の順であり、逆順にはなりません。', 'Metropolitan Museum of Art': 'コンストラクタに渡された値は"Met"であり、met.nameに入るのは"Met"でフルネームではありません。', 'Error': 'コンストラクタ呼び出しと文字列連結はいずれも正常な操作で、例外は発生しません。' }),
  execute('us_java_e07', 'inheritance', 'Pony Express: override dispatch', 'Pony Express の継承コードで実際に呼ばれるメソッドの出力を選んでください。', 'class MailRoute {\n    String period() { return "general mail"; }\n}\nclass PonyExpress extends MailRoute {\n    @Override\n    String period() { return "1860-1861"; }\n}\npublic class Main {\n    public static void main(String[] args) {\n        MailRoute route = new PonyExpress();\n        System.out.println(route.period());\n    }\n}', ['1860-1861', 'general mail', 'PonyExpress', 'Error'], '1860-1861', '変数の型より、実際のオブジェクトのクラスを見ます。', '実体は PonyExpress なので、オーバーライドされた period() が呼ばれます。', 'Java の動的ディスパッチでは、実行時のオブジェクト型のメソッドが選ばれます。', { '1860-1861': '正解。routeの実体（実際に生成されたオブジェクト）はPonyExpressなので、overrideされたperiod()が呼ばれます。', 'general mail': '変数の宣言型はMailRouteですが、実行時にはPonyExpressのoverrideされたメソッドが呼ばれるため親クラスの値は使われません。', 'PonyExpress': 'これは型の名前であり、period()メソッドが返す文字列ではありません。', 'Error': 'PonyExpressはMailRouteを正しく継承してoverrideしているため、コンパイルも実行も問題なく行われます。' }),
];
...
export const US_JAVA_DEBUG = [
  debug('us_java_b01', 'operators', 'Baseball batting average: integer division bug', '野球の打率を計算する Java コードの不具合を、原因・修正・影響の3段階で確認します。', 'public class Main {\n    public static void main(String[] args) {\n        int hits = 30;\n        int atBats = 100;\n        double average = hits / atBats;\n        System.out.println(average);\n    }\n}', [
    debugStep(1, '原因を特定', '30安打100打数なら0.3になるはずですが、0.0になります。', '主な原因はどれですか。', ['int 同士の割り算で小数部分が落ちている', 'println が使えない', '変数名 hits が長すぎる'], 'int 同士の割り算で小数部分が落ちている', '割り算の前にどちらかを double にします。', 'int / int は整数除算になります。', { 'int 同士の割り算で小数部分が落ちている': '正解。hitsとatBatsはどちらもintなので30/100は整数除算で0になり、小数部分が切り捨てられてからdoubleに代入されます。', 'println が使えない': 'System.out.println(average)自体は正しく書けており、出力文の指定ミスではありません。', '変数名 hits が長すぎる': '変数名の長さはJavaの動作に影響せず、原因ではありません。' }),
    debugStep(2, '修正を選ぶ', '小数を残す最小修正を選びます。', '正しい修正はどれですか。', ['double average = (double) hits / atBats;', 'double average = hits / atBats;', 'int average = hits / atBats;'], 'double average = (double) hits / atBats;', '片方を double にキャストします。', 'double を含む割り算になり、小数が残ります。', { 'double average = (double) hits / atBats;': '正解。(double)でhitsをキャストすることで、割り算全体が小数演算になり0.3を正しく得られます。', 'double average = hits / atBats;': '右辺がint同士の整数除算のままなので、doubleに代入しても結果は0.0になります。', 'int average = hits / atBats;': 'int型に代入すると小数部分はそもそも保持できず、打率の表示には使えません。' }),
    debugStep(3, '影響を説明', '修正後の出力を確認します。', '修正の影響として正しいものはどれですか。', ['0.3 のような小数の打率を出せる', '必ず1になる', 'コンパイルできなくなる'], '0.3 のような小数の打率を出せる', '30 / 100 を小数として計算します。', '整数除算による情報の欠落を防げます。', { '0.3 のような小数の打率を出せる': '正解。(double)キャストにより30÷100が小数演算になり、0.3という正しい打率を表示できます。', '必ず1になる': '小数演算の結果は0.3であり、1になることはありません。', 'コンパイルできなくなる': 'このキャストは正しいJava構文で、コンパイルエラーにはなりません。' }),
  ...
  debug('us_java_b02', 'arrays', 'Columbia River Gorge: array bounds bug', 'コロンビア川峡谷の州境データを扱う Java コードの不具合を、原因・修正・影響の3段階で確認します。', 'public class Main {\n    public static void main(String[] args) {\n        String[] states = {"Oregon", "Washington"};\n        for (int i = 0; i <= states.length; i++) {\n            System.out.println(states[i]);\n        }\n    }\n}', [
    debugStep(1, '原因を特定', '最後に配列範囲外エラーになります。', '主な原因はどれですか。', ['i <= states.length で最後に存在しない添字を読む', 'states が空である', 'println が配列を出せない'], 'i <= states.length で最後に存在しない添字を読む', '添字の最大値は length - 1 です。', 'i == states.length のとき範囲外です。', { 'i <= states.length で最後に存在しない添字を読む': '正解。statesは2要素（添字0〜1）しかなく、<=だとiが2のときも実行されstates[2]は範囲外になります。', 'states が空である': 'statesにはOregonとWashingtonの2要素が正しく格納されており、空ではありません。', 'println が配列を出せない': 'System.out.println(states[i])自体は配列要素を出力する正しい構文です。' }),
    debugStep(2, '修正を選ぶ', '全要素だけを安全に出力します。', '正しい修正はどれですか。', ['i < states.length にする', 'i <= states.length + 1 にする', 'states[2] を追加する'], 'i < states.length にする', '配列ループの基本条件です。', '0 から length - 1 までを回れます。', { 'i < states.length にする': '正解。i < states.lengthはiが0から1までの2回だけループし、範囲内の2要素を安全に処理できます。', 'i <= states.length + 1 にする': 'これは現在より2回多く実行されることになり、範囲外アクセスがさらに増えてしまいます。', 'states[2] を追加する': 'これはコードの修正ではなく配列の要素数を増やす提案で、ループ条件のバグ自体は解決しません。' }),
    debugStep(3, '影響を説明', '修正後の動作を確認します。', '修正の影響はどれですか。', ['Oregon と Washington だけを安全に出力できる', 'どちらも出力されない', '同じ州が無限に出る'], 'Oregon と Washington だけを安全に出力できる', '存在する2要素だけを読むためです。', '範囲外アクセスを防ぎます。', { 'Oregon と Washington だけを安全に出力できる': '正解。i < states.lengthによりiは0と1の2回ループし、範囲内の2州だけを安全に出力できます。', 'どちらも出力されない': '修正後もループは0と1の2回実行されるため、両方の州が出力されます。', '同じ州が無限に出る': 'forループは終了条件を持つ通常のループで、無限ループにはなりません。' }),
  ...
  debug('us_java_b03', 'null-safety', 'Hollywood Walk of Fame: null method bug', 'Hollywood Walk of Fame の星カテゴリを扱う Java コードの不具合を、原因・修正・影響の3段階で確認します。', 'public class Main {\n    public static void main(String[] args) {\n        String category = null;\n        if (category.equals("Film")) {\n            System.out.println("star");\n        }\n    }\n}', [
    debugStep(1, '原因を特定', 'NullPointerException が起きます。', '主な原因はどれですか。', ['null の変数に equals を呼んでいる', 'Film が長すぎる', 'if 文が使えない'], 'null の変数に equals を呼んでいる', 'メソッドを呼ぶ相手が null か確認します。', 'null にはメソッドを呼べません。', { 'null の変数に equals を呼んでいる': '正解。categoryはnullなので、category.equals("Film")を呼ぶとNullPointerExceptionになります。', 'Film が長すぎる': '"Film"は短い通常の文字列リテラルで、長さの問題ではありません。', 'if 文が使えない': 'if文自体の構文は正しく書けており、使えないわけではありません。' }),
    debugStep(2, '修正を選ぶ', 'null でも落ちない修正を選びます。', '正しい修正はどれですか。', ['if ("Film".equals(category))', 'if (category.equals("Film"))', 'if (category = "Film")'], 'if ("Film".equals(category))', '文字列リテラル側から equals を呼ぶと安全です。', '"Film" は null ではないため、引数が null でも false になります。', { 'if ("Film".equals(category))': '正解。"Film"は常にnullではないオブジェクトなので、categoryがnullでも例外を起こさずfalseと判定できます。', 'if (category.equals("Film"))': 'これは元のコードと同じで、categoryがnullのままならNullPointerExceptionが解消されません。', 'if (category = "Film")': 'これは比較ではなく代入で、if文の条件としては意図と異なる動作になります。' }),
    debugStep(3, '影響を説明', '修正後の動作を確認します。', '修正の影響はどれですか。', ['category が null でも例外にならず判定できる', '必ず star と出る', 'コンパイル不能になる'], 'category が null でも例外にならず判定できる', 'null は一致しない値として扱われます。', 'レビュー画面などで欠損データがあっても落ちにくくなります。', { 'category が null でも例外にならず判定できる': '正解。"Film".equals(category)はcategoryがnullでも安全にfalseを返し、例外を避けられます。', '必ず star と出る': 'categoryがnullの場合は条件がfalseになるため、starは出力されません。', 'コンパイル不能になる': '"Film".equals(category)は正しいJava構文で、コンパイルエラーにはなりません。' }),
  ...
  debug('us_java_b04', 'static', 'Empire State Building: static instance bug', 'Empire State Building の開業年を扱う Java コードの不具合を、原因・修正・影響の3段階で確認します。', 'class Building {\n    int opened = 1931;\n}\npublic class Main {\n    public static void main(String[] args) {\n        System.out.println(Building.opened);\n    }\n}', [
    debugStep(1, '原因を特定', 'opened にアクセスできません。', '主な原因はどれですか。', ['インスタンスフィールドをクラス名から読んでいる', '1931 は int ではない', 'class は使えない'], 'インスタンスフィールドをクラス名から読んでいる', 'static か instance かを見ます。', 'opened は static ではありません。', { 'インスタンスフィールドをクラス名から読んでいる': '正解。openedはstaticではない通常のフィールドなので、Building.openedのようにクラス名から直接読むことはできません。', '1931 は int ではない': '1931は通常の整数リテラルで、int型として正しく扱えます。', 'class は使えない': 'class Buildingの定義自体は正しいJava構文で、問題はフィールドへのアクセス方法です。' }),
    debugStep(2, '修正を選ぶ', 'インスタンスフィールドとして読む修正を選びます。', '正しい修正はどれですか。', ['Building building = new Building(); System.out.println(building.opened);', 'System.out.println(Building.opened);', 'System.out.println(opened);'], 'Building building = new Building(); System.out.println(building.opened);', 'new でオブジェクトを作ります。', 'インスタンスのフィールドはオブジェクト参照から読みます。', { 'Building building = new Building(); System.out.println(building.opened);': '正解。インスタンスを生成し、そのオブジェクトを通じてopenedを読むことで正しくアクセスできます。', 'System.out.println(Building.opened);': 'これは元のコードと同じで、staticではないフィールドをクラス名から読むため依然としてコンパイルエラーになります。', 'System.out.println(opened);': 'main内にopenedという変数は存在しないため、コンパイルエラーになります。' }),
    debugStep(3, '影響を説明', '修正後の出力を確認します。', '修正の影響はどれですか。', ['1931 を正しく出力できる', '必ず0になる', 'static でないと Java は動かない'], '1931 を正しく出力できる', '作成した Building の opened フィールドを読むためです。', 'static と instance の役割を分けて扱えます。', { '1931 を正しく出力できる': '正解。インスタンスbuildingを生成しbuilding.openedを読むことで、初期値1931が正しく出力されます。', '必ず0になる': 'openedの初期値は1931で宣言されており、0になることはありません。', 'static でないと Java は動かない': 'staticでないインスタンスフィールドも正常に動作し、Javaの実行に支障はありません。' }),
  ...
  debug('us_java_b05', 'loops', 'United States census: off-by-one loop bug', '10年ごとの国勢調査年を扱う Java コードの不具合を、原因・修正・影響の3段階で確認します。', 'public class Main {\n    public static void main(String[] args) {\n        int[] years = {2000, 2010, 2020};\n        for (int i = 0; i <= years.length; i++) {\n            System.out.println(years[i]);\n        }\n    }\n}', [
    debugStep(1, '原因を特定', '最後に配列範囲外エラーになります。', '主な原因はどれですか。', ['ループ条件が1回多く回る', '10年ごとではない', 'int 配列は使えない'], 'ループ条件が1回多く回る', 'i が length と等しいときの添字を考えます。', '最後の有効添字は length - 1 です。', { 'ループ条件が1回多く回る': '正解。<=だとiがyears.length（3）のときも実行され、years[3]は範囲外でArrayIndexOutOfBoundsExceptionになります。', '10年ごとではない': '2000,2010,2020は正しく10年間隔のデータで、間隔の問題ではありません。', 'int 配列は使えない': 'int配列の宣言・初期化自体は正しく書けており、使えないわけではありません。' }),
    debugStep(2, '修正を選ぶ', '3つの年だけを出力します。', '正しい修正はどれですか。', ['i < years.length', 'i <= years.length', 'i < years.length + 1'], 'i < years.length', '配列ループの終了条件です。', '0,1,2 の3回だけ回ります。', { 'i < years.length': '正解。i < years.lengthはiが0,1,2の3回だけループし、範囲内の3要素を安全に処理できます。', 'i <= years.length': 'これは元のコードと同じ条件で、依然としてyears[3]の範囲外アクセスが発生します。', 'i < years.length + 1': 'これはi <= years.lengthと同じ範囲（0〜3）を回ることになり、同じ例外が起きます。' }),
    debugStep(3, '影響を説明', '修正後の動作を確認します。', '修正の影響はどれですか。', ['2000, 2010, 2020 を範囲外エラーなしで出力できる', '2020 だけ出る', '何も出ない'], '2000, 2010, 2020 を範囲外エラーなしで出力できる', '配列内の3要素だけを読むためです。', 'off-by-one の境界ミスを防げます。', { '2000, 2010, 2020 を範囲外エラーなしで出力できる': '正解。i < years.lengthによりiは0,1,2の3回ループし、3つの年すべてを範囲内で出力できます。', '2020 だけ出る': '修正後もループは0から2まで実行されるため、2000と2010も出力されます。', '何も出ない': 'ループは0,1,2の3回正しく実行されるため、3つの年がすべて出力されます。' }),
...
export const US_JAVA_FINAL_MISSIONS = {
  ...
  execute: {
    ...
    unlock: { requiresStageClear: true },
    questions: [
      execute('final_execute_US_java_01', 'collections', 'Selma to Montgomery Trail: final list filter order', '1965年の投票権行進を記念するルートデータを、条件で絞って順に出力した結果を選んでください。', 'import java.util.ArrayList;\nclass Stop {\n    String name; int order; boolean votingRights;\n    Stop(String name, int order, boolean votingRights) { this.name = name; this.order = order; this.votingRights = votingRights; }\n}\npublic class Main {\n    public static void main(String[] args) {\n        ArrayList<Stop> stops = new ArrayList<>();\n        stops.add(new Stop("Selma", 1, true));\n        stops.add(new Stop("Lowndes", 2, true));\n        stops.add(new Stop("Other", 3, false));\n        String result = "";\n        for (Stop stop : stops) {\n            if (stop.votingRights && stop.order <= 2) {\n                result += stop.name + ">";\n            }\n        }\n        System.out.println(result.substring(0, result.length() - 1));\n    }\n}', ['Selma>Lowndes', 'Lowndes>Selma', 'Selma>Lowndes>Other', 'Other'], 'Selma>Lowndes', '条件に合う行だけを配列順に連結します。', 'votingRights が true で order が2以下の2件だけが残り、末尾の > を削ります。', 'オブジェクトリスト、boolean 条件、数値比較、文字列連結を組み合わせています。', { 'Selma>Lowndes': '正解。votingRightsがtrueでorder<=2を満たすのはSelma(1)とLowndes(2)で、stopsの順（Selmaが先）に連結されます。', 'Lowndes>Selma': '拡張forはstopsの並び順（Selmaが先）通りに処理するため、この逆順にはなりません。', 'Selma>Lowndes>Other': 'OtherはvotingRightsがfalseのため条件を満たさず、結果に追加されません。', 'Other': 'OtherはvotingRights=falseで除外され、条件を満たすSelmaとLowndesが結果に含まれます。' }),
      execute('final_execute_US_java_02', 'collections', 'Mammoth Cave: final HashMap loop method', 'Mammoth Cave の世界遺産登録年を HashMap とメソッドで判定した出力を選んでください。', 'import java.util.HashMap;\npublic class Main {\n    static String label(String name, int year) {\n        if (year == 1981) {\n            return name + ":World Heritage";\n        }\n        return name + ":Other";\n    }\n    public static void main(String[] args) {\n        HashMap<String, Integer> years = new HashMap<>();\n        years.put("Mammoth Cave", 1981);\n        years.put("Other Cave", 1995);\n        for (String name : years.keySet()) {\n            if (name.equals("Mammoth Cave")) {\n                System.out.println(label(name, years.get(name)));\n            }\n        }\n    }\n}', ['Mammoth Cave:World Heritage', 'Mammoth Cave:Other', 'Other Cave:World Heritage', '1981'], 'Mammoth Cave:World Heritage', 'keySet で名前を取り、対象名だけ label に渡します。', 'Mammoth Cave の年は1981なので label は World Heritage を返します。', 'HashMap、keySet、equals、メソッド戻り値をまとめて追跡します。', { 'Mammoth Cave:World Heritage': '正解。Mammoth Caveの年は1981なのでlabel内のif (year == 1981)がtrueになり、World Heritageが連結されます。', 'Mammoth Cave:Other': 'Mammoth Caveの年は1981であり、if (year == 1981)の条件を満たすためOtherではなくWorld Heritageが返ります。', 'Other Cave:World Heritage': 'if (name.equals("Mammoth Cave"))によりOther Caveは出力対象から除外されます。', '1981': 'labelはname + ":World Heritage"という文字列を返すメソッドで、年の数値だけが出力されるわけではありません。' }),
      execute('final_execute_US_java_03', 'classes', 'Space Needle: final object list method', 'Space Needle のデータをオブジェクト、ArrayList、条件、メソッドで処理した出力を選んでください。', 'import java.util.ArrayList;\nclass Landmark {\n    String name; int year; String event;\n    Landmark(String name, int year, String event) { this.name = name; this.year = year; this.event = event; }\n    String label() { return name + ":" + event; }\n}\npublic class Main {\n    public static void main(String[] args) {\n        ArrayList<Landmark> sites = new ArrayList<>();\n        sites.add(new Landmark("Space Needle", 1962, "Seattle World Fair"));\n        sites.add(new Landmark("Other Tower", 1970, "Other Fair"));\n        for (Landmark site : sites) {\n            if (site.year == 1962) {\n                System.out.println(site.label());\n            }\n        }\n    }\n}', ['Space Needle:Seattle World Fair', 'Other Tower:Other Fair', 'Space Needle:1962', 'Seattle World Fair:Space Needle'], 'Space Needle:Seattle World Fair', '1962年のオブジェクトだけ label() が呼ばれます。', '条件に合うのは Space Needle で、label() は name と event をコロンで連結します。', 'クラス、コンストラクタ、ArrayList、条件分岐、インスタンスメソッドを組み合わせています。', { 'Space Needle:Seattle World Fair': '正解。site.year == 1962を満たすのはSpace Needleだけなので、label()が呼ばれてこの1件が出力されます。', 'Other Tower:Other Fair': 'Other Towerのyearは1970で1962とは一致しないため、if条件を満たさず出力されません。', 'Space Needle:1962': 'label()はname + ":" + eventを返すため、yearの数値ではなくeventの文字列が連結されます。', 'Seattle World Fair:Space Needle': 'label()の連結順はnameが先でeventが後であり、この逆順にはなりません。' }),
    ],
  },
  debug: {
    ...
    questions: [
      debug('final_debug_US_java_01', 'exceptions', 'Gateway Arch: final parsing bug', 'Gateway Arch の高さ "630 ft" を数値化する Java コードの不具合を、原因・修正・影響の3段階で確認します。', 'public class Main {\n    public static void main(String[] args) {\n        String heightText = "630 ft";\n        int height = Integer.parseInt(heightText);\n        System.out.println(height);\n    }\n}', [
        debugStep(1, '原因を特定', '"630 ft" をそのまま parseInt して例外になります。', '主な原因はどれですか。', ['数値以外の ft を含んだ文字列を整数変換している', '630 は整数ではない', 'println が int を出せない'], '数値以外の ft を含んだ文字列を整数変換している', 'parseInt は数字だけの文字列を期待します。', 'ft が含まれているため NumberFormatException になります。', { '数値以外の ft を含んだ文字列を整数変換している': '正解。"630 ft"には数字以外の" ft"が含まれており、parseIntは数字だけの文字列を期待するためNumberFormatExceptionになります。', '630 は整数ではない': '630自体は正しい整数の値で、問題は文字列に余分な単位が含まれていることです。', 'println が int を出せない': 'System.out.println(height)はint値を正しく出力できる構文です。' }),
        debugStep(2, '修正を選ぶ', '前処理と例外処理を入れた修正を選びます。', '正しい修正はどれですか。', ['String numberOnly = heightText.replace(" ft", ""); int height = Integer.parseInt(numberOnly);', 'int height = Integer.parseInt(heightText);', 'int height = 0;'], 'String numberOnly = heightText.replace(" ft", ""); int height = Integer.parseInt(numberOnly);', '単位を取り除いてから変換します。', '数字部分だけにすると安全に整数化できます。', { 'String numberOnly = heightText.replace(" ft", ""); int height = Integer.parseInt(numberOnly);': '正解。" ft"を取り除いて"630"だけの文字列にすることで、parseIntが正しく数値に変換できます。', 'int height = Integer.parseInt(heightText);': 'これは元のコードと同じで、heightTextに" ft"が含まれたままなので同じ例外が起きます。', 'int height = 0;': 'これは変換自体をやめて固定値0を使うだけで、実際の高さ630を反映できません。' }),
        debugStep(3, '影響を説明', '修正後の動作を確認します。', '修正の影響はどれですか。', ['630 を数値として扱える', 'ft だけが出力される', '必ず例外になる'], '630 を数値として扱える', '変換前の文字列から単位を除くためです。', '高さの比較や計算に使える数値になります。', { '630 を数値として扱える': '正解。" ft"を除いた"630"をparseIntで変換することで、630という整数値を正しく扱えます。', 'ft だけが出力される': 'heightにはreplaceとparseIntの結果である数値630が入り、"ft"という文字列が出力されることはありません。', '必ず例外になる': '単位を取り除いた後の"630"はparseIntで正しく変換でき、例外は発生しません。' }),
      ...
      debug('final_debug_US_java_02', 'collections', 'Boston Freedom Trail: final missing key bug', 'Boston Freedom Trail の地点データを HashMap で扱う Java コードの不具合を、原因・修正・影響の3段階で確認します。', 'import java.util.HashMap;\npublic class Main {\n    public static void main(String[] args) {\n        HashMap<String, String> sites = new HashMap<>();\n        sites.put("Common", "Boston Common");\n        sites.put("House", "Old State House");\n        String site = sites.get("Church");\n        System.out.println(site.toUpperCase());\n    }\n}', [
        debugStep(1, '原因を特定', 'HashMap から取り出した値が null になり例外が起きます。', '主な原因はどれですか。', ['存在しないキー Church を get している', 'HashMap は文字列を保存できない', 'toUpperCase は常に失敗する'], '存在しないキー Church を get している', 'put したキー一覧と get のキーを比べます。', 'ないキーの get は null を返します。', { '存在しないキー Church を get している': '正解。sitesにはCommonとHouseしか登録されておらず、Churchを読むとgetがnullを返し、site.toUpperCase()でNullPointerExceptionになります。', 'HashMap は文字列を保存できない': 'sitesは正しくString型の値（"Boston Common"など）を保存できています。', 'toUpperCase は常に失敗する': 'toUpperCase()はnullでない文字列に対しては正常に動作するメソッドです。' }),
        debugStep(2, '修正を選ぶ', '欠損キーでも安全な修正を選びます。', '正しい修正はどれですか。', ['String site = sites.getOrDefault("Church", "Unknown site");', 'String site = sites.get("Church");', 'sites = null;'], 'String site = sites.getOrDefault("Church", "Unknown site");', 'getOrDefault はキーがないときの代替値を指定できます。', 'null ではない文字列が入るため toUpperCase を呼べます。', { 'String site = sites.getOrDefault("Church", "Unknown site");': '正解。getOrDefaultはキーが無い場合に代替値"Unknown site"を返すため、siteがnullにならずtoUpperCaseを安全に呼べます。', 'String site = sites.get("Church");': 'これは元のコードと同じで、Churchが登録されていないままなのでnullが返り問題は解決しません。', 'sites = null;': 'これはHashMap自体をnullにしてしまい、後続の処理がすべて失敗する別の問題を生みます。' }),
        debugStep(3, '影響を説明', '修正後の動作を確認します。', '修正の影響はどれですか。', ['キーがない地点でも落ちずに Unknown site を表示できる', '必ず Boston Common になる', 'HashMap が空になる'], 'キーがない地点でも落ちずに Unknown site を表示できる', '代替値を用意したためです。', 'ルート地点の入力ゆれや欠損に強くなります。', { 'キーがない地点でも落ちずに Unknown site を表示できる': '正解。getOrDefaultにより、Churchのような未登録キーでも例外を起こさず代替値Unknown siteを表示できます。', '必ず Boston Common になる': 'Boston CommonはキーCommonに対応する値で、キーChurchを読む今回のコードでは返りません。', 'HashMap が空になる': '修正は読み取り方法を変えるだけで、sites自体に登録されたデータが消えるわけではありません。' }),
      ...
      debug('final_debug_US_java_03', 'inheritance', 'Navajo Code Talkers: final override signature bug', 'Navajo Code Talkers の通信コードを扱う Java コードの不具合を、原因・修正・影響の3段階で確認します。', 'class CodeSystem {\n    String encode(String word) { return "plain:" + word; }\n}\nclass NavajoCode extends CodeSystem {\n    @Override\n    String encode(Object word) { return "code:" + word; }\n}\npublic class Main {\n    public static void main(String[] args) {\n        CodeSystem system = new NavajoCode();\n        System.out.println(system.encode("message"));\n    }\n}', [
        debugStep(1, '原因を特定', '@Override の行でコンパイルエラーになります。', '主な原因はどれですか。', ['引数型が String ではなく Object で、親メソッドと署名が違う', 'message が短すぎる', '継承は Java で使えない'], '引数型が String ではなく Object で、親メソッドと署名が違う', 'オーバーライドはメソッド名だけでなく引数も一致します。', 'Object 引数では別メソッド扱いになります。', { '引数型が String ではなく Object で、親メソッドと署名が違う': '正解。親のencode(String word)に対し子はencode(Object word)と引数型が異なり、署名が一致しないため@Overrideがエラーになります。', 'message が短すぎる': '"message"は正しい文字列リテラルで、長さの問題ではありません。', '継承は Java で使えない': 'extendsによるクラス継承自体は正しいJavaの機能で、使えないわけではありません。' }),
        debugStep(2, '修正を選ぶ', '正しくオーバーライドする修正を選びます。', '正しい修正はどれですか。', ['String encode(String word) にする', 'String encode(Object word) のままにする', '@Override を消して何もしない'], 'String encode(String word) にする', '親と同じ引数型にします。', '@Override が親メソッドとの一致を検査してくれます。', { 'String encode(String word) にする': '正解。親のencode(String word)と同じ引数型にすることで、正しくオーバーライドできます。', 'String encode(Object word) のままにする': 'これは元のコードと同じ引数型で、依然として親と署名が一致せずコンパイルエラーが解消されません。', '@Override を消して何もしない': '@Overrideを消すと単なる別メソッドのオーバーロードになり、system.encode("message")がどちらを呼ぶか意図通りに動きません。' }),
        debugStep(3, '影響を説明', '修正後の動作を確認します。', '修正の影響はどれですか。', ['NavajoCode 側の encode が呼ばれ code:message と出る', 'plain:message だけになる', '何も出ない'], 'NavajoCode 側の encode が呼ばれ code:message と出る', '実体は NavajoCode だからです。', '正しい署名なら動的ディスパッチで子クラスの処理が使われます。', { 'NavajoCode 側の encode が呼ばれ code:message と出る': '正解。systemの実体はNavajoCodeで、正しく署名を合わせたオーバーライドにより子クラス側のencodeが呼ばれます。', 'plain:message だけになる': '動的ディスパッチにより、実体であるNavajoCode側のencode（code:を付けるもの）が呼ばれます。', '何も出ない': '正しくオーバーライドされたメソッドが呼ばれてcode:messageが出力されるため、何も出ないことはありません。' }),
