...
import { AUSTRALIA_FINAL_MISSIONS } from './australia_questions.js';
import { EGYPT_FINAL_MISSIONS } from './egypt_questions.js';
import { INDIA_FINAL_MISSIONS } from './india_questions.js';
import { RUSSIA_FINAL_MISSIONS } from './russia_questions.js';
...
import { KOREA_FINAL_MISSIONS } from './korea_questions.js';
        ...
        "questions": [
          {
            ...
            "description": "大日本帝国憲法の公布を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "Meiji Constitution promulgation context",
          ...
          },
          {
            ...
            "description": "大江健三郎とノーベル文学賞を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "Kenzaburo Oe Nobel Literature",
            "hint": "`record` は辞書です。条件が True のときに表示したい記録名のキーを選びます。",
          ...
          },
          {
            ...
            "description": "金閣寺と鹿苑寺を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "Kinkaku-ji and Rokuon-ji naming",
            "hint": "`record` は辞書です。条件が True のときに表示したい記録名のキーを選びます。",
        ...
        "questions": [
          {
            ...
            "expectedOutput": "Hokusai and Thirty-six Views of Mount Fuji",
          ...
          },
          {
            ...
            "description": "スーパーカミオカンデを題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "Super-Kamiokande",
            "hint": "`find` で残った object から、表示したい名前のプロパティを読みます。",
          ...
          },
          {
            ...
            "description": "厳島神社を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "Itsukushima Shrine",
            "hint": "`find` で残った object から、表示したい名前のプロパティを読みます。",
        ...
        "questions": [
          {
            ...
            "description": "権利章典を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "True",
          ...
          },
          {
            ...
            "description": "トニ・モリスンを題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "Beloved",
          ...
          },
          {
            ...
            "description": "アメリカ合衆国の国璽を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "True",
        ...
        "questions": [
          {
            ...
            "description": "キング牧師とノーベル平和賞を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "Martin Luther King Jr.: 1964",
          ...
          },
          {
            ...
            "description": "憲法修正第1条を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "true",
          ...
          },
          {
            ...
            "description": "ラシュモア山を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
            "expectedOutput": "Washington / Jefferson / Lincoln / Roosevelt",
...
FINAL_MISSIONS.decode.AU ??= {};
FINAL_MISSIONS.execute.AU ??= {};
FINAL_MISSIONS.debug.AU ??= {};
FINAL_MISSIONS.decode.AU.python = AUSTRALIA_FINAL_MISSIONS.decode.python;
FINAL_MISSIONS.execute.AU.python = AUSTRALIA_FINAL_MISSIONS.execute.python;
FINAL_MISSIONS.debug.AU.python = AUSTRALIA_FINAL_MISSIONS.debug.python;
FINAL_MISSIONS.decode.AU.javascript = AUSTRALIA_FINAL_MISSIONS.decode.javascript;
FINAL_MISSIONS.execute.AU.javascript = AUSTRALIA_FINAL_MISSIONS.execute.javascript;
FINAL_MISSIONS.debug.AU.javascript = AUSTRALIA_FINAL_MISSIONS.debug.javascript;
FINAL_MISSIONS.decode.AU.java = AUSTRALIA_FINAL_MISSIONS.decode.java;
FINAL_MISSIONS.execute.AU.java = AUSTRALIA_FINAL_MISSIONS.execute.java;
FINAL_MISSIONS.debug.AU.java = AUSTRALIA_FINAL_MISSIONS.debug.java;
FINAL_MISSIONS.decode.EG ??= {};
FINAL_MISSIONS.execute.EG ??= {};
FINAL_MISSIONS.debug.EG ??= {};
FINAL_MISSIONS.decode.EG.python = EGYPT_FINAL_MISSIONS.decode.python;
FINAL_MISSIONS.execute.EG.python = EGYPT_FINAL_MISSIONS.execute.python;
FINAL_MISSIONS.debug.EG.python = EGYPT_FINAL_MISSIONS.debug.python;
FINAL_MISSIONS.decode.EG.javascript = EGYPT_FINAL_MISSIONS.decode.javascript;
FINAL_MISSIONS.execute.EG.javascript = EGYPT_FINAL_MISSIONS.execute.javascript;
FINAL_MISSIONS.debug.EG.javascript = EGYPT_FINAL_MISSIONS.debug.javascript;
FINAL_MISSIONS.decode.EG.java = EGYPT_FINAL_MISSIONS.decode.java;
FINAL_MISSIONS.execute.EG.java = EGYPT_FINAL_MISSIONS.execute.java;
FINAL_MISSIONS.debug.EG.java = EGYPT_FINAL_MISSIONS.debug.java;
FINAL_MISSIONS.decode.IN ??= {};
FINAL_MISSIONS.execute.IN ??= {};
FINAL_MISSIONS.debug.IN ??= {};
FINAL_MISSIONS.decode.IN.python = INDIA_FINAL_MISSIONS.decode.python;
FINAL_MISSIONS.execute.IN.python = INDIA_FINAL_MISSIONS.execute.python;
FINAL_MISSIONS.debug.IN.python = INDIA_FINAL_MISSIONS.debug.python;
FINAL_MISSIONS.decode.IN.javascript = INDIA_FINAL_MISSIONS.decode.javascript;
FINAL_MISSIONS.execute.IN.javascript = INDIA_FINAL_MISSIONS.execute.javascript;
FINAL_MISSIONS.debug.IN.javascript = INDIA_FINAL_MISSIONS.debug.javascript;
FINAL_MISSIONS.decode.IN.java = INDIA_FINAL_MISSIONS.decode.java;
FINAL_MISSIONS.execute.IN.java = INDIA_FINAL_MISSIONS.execute.java;
FINAL_MISSIONS.debug.IN.java = INDIA_FINAL_MISSIONS.debug.java;
FINAL_MISSIONS.decode.RU ??= {};
FINAL_MISSIONS.execute.RU ??= {};
FINAL_MISSIONS.debug.RU ??= {};
FINAL_MISSIONS.decode.RU.python = RUSSIA_FINAL_MISSIONS.decode.python;
FINAL_MISSIONS.execute.RU.python = RUSSIA_FINAL_MISSIONS.execute.python;
FINAL_MISSIONS.debug.RU.python = RUSSIA_FINAL_MISSIONS.debug.python;
FINAL_MISSIONS.decode.RU.javascript = RUSSIA_FINAL_MISSIONS.decode.javascript;
FINAL_MISSIONS.execute.RU.javascript = RUSSIA_FINAL_MISSIONS.execute.javascript;
FINAL_MISSIONS.debug.RU.javascript = RUSSIA_FINAL_MISSIONS.debug.javascript;
FINAL_MISSIONS.decode.RU.java = RUSSIA_FINAL_MISSIONS.decode.java;
FINAL_MISSIONS.execute.RU.java = RUSSIA_FINAL_MISSIONS.execute.java;
FINAL_MISSIONS.debug.RU.java = RUSSIA_FINAL_MISSIONS.debug.java;
FINAL_MISSIONS.decode.CN ??= {};
FINAL_MISSIONS.execute.CN ??= {};
FINAL_MISSIONS.debug.CN ??= {};
FINAL_MISSIONS.decode.CN.python = CHINA_FINAL_MISSIONS.decode.python;
FINAL_MISSIONS.execute.CN.python = CHINA_FINAL_MISSIONS.execute.python;
FINAL_MISSIONS.debug.CN.python = CHINA_FINAL_MISSIONS.debug.python;
FINAL_MISSIONS.decode.CN.javascript = CHINA_FINAL_MISSIONS.decode.javascript;
FINAL_MISSIONS.execute.CN.javascript = CHINA_FINAL_MISSIONS.execute.javascript;
FINAL_MISSIONS.debug.CN.javascript = CHINA_FINAL_MISSIONS.debug.javascript;
FINAL_MISSIONS.decode.CN.java = CHINA_FINAL_MISSIONS.decode.java;
FINAL_MISSIONS.execute.CN.java = CHINA_FINAL_MISSIONS.execute.java;
FINAL_MISSIONS.debug.CN.java = CHINA_FINAL_MISSIONS.debug.java;
FINAL_MISSIONS.decode.DE ??= {};
FINAL_MISSIONS.execute.DE ??= {};
FINAL_MISSIONS.debug.DE ??= {};
FINAL_MISSIONS.decode.DE.python = GERMANY_FINAL_MISSIONS.decode.python;
FINAL_MISSIONS.execute.DE.python = GERMANY_FINAL_MISSIONS.execute.python;
FINAL_MISSIONS.debug.DE.python = GERMANY_FINAL_MISSIONS.debug.python;
FINAL_MISSIONS.decode.DE.javascript = GERMANY_FINAL_MISSIONS.decode.javascript;
FINAL_MISSIONS.execute.DE.javascript = GERMANY_FINAL_MISSIONS.execute.javascript;
FINAL_MISSIONS.debug.DE.javascript = GERMANY_FINAL_MISSIONS.debug.javascript;
FINAL_MISSIONS.decode.DE.java = GERMANY_FINAL_MISSIONS.decode.java;
FINAL_MISSIONS.execute.DE.java = GERMANY_FINAL_MISSIONS.execute.java;
FINAL_MISSIONS.debug.DE.java = GERMANY_FINAL_MISSIONS.debug.java;
FINAL_MISSIONS.decode.GB ??= {};
FINAL_MISSIONS.execute.GB ??= {};
FINAL_MISSIONS.debug.GB ??= {};
FINAL_MISSIONS.decode.GB.python = UNITED_KINGDOM_FINAL_MISSIONS.decode.python;
FINAL_MISSIONS.execute.GB.python = UNITED_KINGDOM_FINAL_MISSIONS.execute.python;
FINAL_MISSIONS.debug.GB.python = UNITED_KINGDOM_FINAL_MISSIONS.debug.python;
FINAL_MISSIONS.decode.GB.javascript = UNITED_KINGDOM_FINAL_MISSIONS.decode.javascript;
FINAL_MISSIONS.execute.GB.javascript = UNITED_KINGDOM_FINAL_MISSIONS.execute.javascript;
FINAL_MISSIONS.debug.GB.javascript = UNITED_KINGDOM_FINAL_MISSIONS.debug.javascript;
...
FINAL_MISSIONS.decode.KR ??= {};
FINAL_MISSIONS.execute.KR ??= {};
FINAL_MISSIONS.debug.KR ??= {};
FINAL_MISSIONS.decode.KR.python = KOREA_FINAL_MISSIONS.decode.python;
FINAL_MISSIONS.execute.KR.python = KOREA_FINAL_MISSIONS.execute.python;
FINAL_MISSIONS.debug.KR.python = KOREA_FINAL_MISSIONS.debug.python;
FINAL_MISSIONS.decode.KR.javascript = KOREA_FINAL_MISSIONS.decode.javascript;
FINAL_MISSIONS.execute.KR.javascript = KOREA_FINAL_MISSIONS.execute.javascript;
FINAL_MISSIONS.debug.KR.javascript = KOREA_FINAL_MISSIONS.debug.javascript;
FINAL_MISSIONS.decode.KR.java = KOREA_FINAL_MISSIONS.decode.java;
FINAL_MISSIONS.execute.KR.java = KOREA_FINAL_MISSIONS.execute.java;
FINAL_MISSIONS.debug.KR.java = KOREA_FINAL_MISSIONS.debug.java;
