...
const styles = {
  ...
  top: { flex: '0 0 auto', display: 'flex', gap: 10, justifyContent: 'space-between', padding: 14, borderBottom: '1px solid rgba(255,166,87,0.22)' },
  ...
  queryFill: { margin: 0, padding: '16px 18px', width: '100%', minWidth: 0, overflowX: 'auto', background: 'rgba(0,5,25,0.95)', border: '1px solid rgba(255,166,87,0.45)', color: '#ffe3c2', fontSize: 13, lineHeight: 1.9, whiteSpace: 'pre', fontFamily: 'var(--mono-font, ui-monospace, SFMono-Regular, Consolas, monospace)' },
  inlineBlank: { minWidth: 110, maxWidth: 'min(420px, 80vw)', background: 'rgba(255,166,87,0.14)', border: '2px solid #ffa657', color: '#ffe3c2', fontFamily: 'inherit', fontSize: 13, padding: '4px 7px', margin: '0 4px', outline: 'none' },
