...
const SOUND_PATTERNS = {
  tap: [
    [
      ...
      { offset: 0, duration: 0.15, frequency: 1318.51, type: 'sine', gain: 0.084, attack: 0.002, release: 0.09 },
      { offset: 0, duration: 0.1, frequency: 3164.4, type: 'sine', gain: 0.032, attack: 0.001, release: 0.06 },
      { offset: 0, duration: 0.13, frequency: 5273.96, type: 'sine', gain: 0.014, attack: 0.001, release: 0.08 },
      { offset: 0.045, duration: 0.09, frequency: 2637.02, type: 'sine', gain: 0.022, attack: 0.002, release: 0.06 },
      { offset: 0.07, duration: 0.07, frequency: 4434.92, type: 'sine', gain: 0.013, attack: 0.001, release: 0.05 },
    ...
    [
      ...
      { offset: 0, duration: 0.14, frequency: 1174.66, type: 'sine', gain: 0.082, attack: 0.002, release: 0.085 },
      { offset: 0, duration: 0.095, frequency: 2819.18, type: 'sine', gain: 0.03, attack: 0.001, release: 0.058 },
      { offset: 0, duration: 0.12, frequency: 4698.64, type: 'sine', gain: 0.013, attack: 0.001, release: 0.075 },
      { offset: 0.042, duration: 0.085, frequency: 2349.32, type: 'sine', gain: 0.021, attack: 0.002, release: 0.055 },
      { offset: 0.065, duration: 0.065, frequency: 3951.07, type: 'sine', gain: 0.012, attack: 0.001, release: 0.045 },
    ...
    [
      ...
      { offset: 0, duration: 0.16, frequency: 1567.98, type: 'sine', gain: 0.08, attack: 0.002, release: 0.095 },
      { offset: 0, duration: 0.105, frequency: 3763.15, type: 'sine', gain: 0.033, attack: 0.001, release: 0.062 },
      { offset: 0, duration: 0.135, frequency: 6271.93, type: 'sine', gain: 0.014, attack: 0.001, release: 0.082 },
      { offset: 0.047, duration: 0.095, frequency: 3135.96, type: 'sine', gain: 0.023, attack: 0.002, release: 0.062 },
      { offset: 0.072, duration: 0.075, frequency: 5274.04, type: 'sine', gain: 0.013, attack: 0.001, release: 0.052 },
      { kind: 'noise', offset: 0, duration: 0.017, frequency: 5800, gain: 0.036 },
    ],
  ],
  back: [
    [
      { offset: 0, duration: 0.07, frequency: 660, type: 'triangle', gain: 0.05, attack: 0.003, release: 0.035 },
      { offset: 0.055, duration: 0.1, frequency: 880, type: 'sine', gain: 0.046, attack: 0.003, release: 0.05 },
      { kind: 'noise', offset: 0, duration: 0.085, frequency: 1500, filterType: 'lowpass', gain: 0.02 },
    ],
    [
      { offset: 0, duration: 0.065, frequency: 587.33, type: 'triangle', gain: 0.048, attack: 0.003, release: 0.032 },
      { offset: 0.05, duration: 0.095, frequency: 783.99, type: 'sine', gain: 0.044, attack: 0.003, release: 0.048 },
      { kind: 'noise', offset: 0, duration: 0.08, frequency: 1350, filterType: 'lowpass', gain: 0.019 },
    ],
  ],
  correct: [
    [
