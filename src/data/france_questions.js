...
const pyExecute = [
  { id: 'fr_py_e01', languageId: 'python', world: 'execute', title: 'Minitel', titleJa: 'ミニテル', category: 'technology-history', objective: 'loop', source: SRC.minitel, summaryJa: 'ミニテルはフランスで普及したオンライン情報端末サービスです。', prompt: 'while ループで作られる出力を選んでください。', code: 'years = [1982, 1990, 2012]\ni = 0\nresult = ""\nwhile i < len(years):\n    result += str(years[i]) + "|"\n    i += 1\nprint(result[:-1])', options: ['1982|1990|2012', '2012|1990|1982', '1982|2012', '1990|2012'], answer: '1982|1990|2012', expectedOutput: '1982|1990|2012', hint: 'i は 0 から順に増えます。', explanation: 'リストの先頭から順に文字列へ追加し、最後の | だけを削ります。', programmingExplanation: 'while では条件が True の間だけ処理を繰り返し、i += 1 で次の添字へ進みます。', optionExplanations: { '1982|1990|2012': '正解。i=0,1,2の順にyears[i]を追加するので、リストの並び順そのままになります。', '2012|1990|1982': 'whileはi=0から増やしていくので逆順にはなりません。', '1982|2012': '3要素全てがwhileループで処理されるため、1990が抜けることはありません。', '1990|2012': '3要素全てがwhileループで処理されるため、先頭の1982が抜けることはありません。' } },
  { id: 'fr_py_e02', languageId: 'python', world: 'execute', title: 'Louis Pasteur and rabies vaccination', titleJa: 'ルイ・パスツールと狂犬病ワクチン', category: 'science-history', objective: 'function', source: SRC.pasteur, summaryJa: 'ルイ・パスツールはワクチン研究などで知られるフランスの科学者です。', prompt: '関数の戻り値と条件分岐を追い、出力を選んでください。', code: 'def status(year):\n    if year >= 1885:\n        return "rabies vaccine era"\n    return "before"\nprint(status(1885))', options: ['rabies vaccine era', 'before', '1885', 'True'], answer: 'rabies vaccine era', expectedOutput: 'rabies vaccine era', hint: '1885 >= 1885 の比較結果を見ます。', explanation: '条件が True なので最初の return が実行されます。', programmingExplanation: 'return は関数の結果を返して処理を終えます。if の比較式が True かを先に判断します。', optionExplanations: { 'rabies vaccine era': '正解。year(1885) >= 1885 がTrueなので最初のreturnが実行されます。', 'before': '条件がTrueの場合は最初のreturnで処理が終わり、2番目のreturn "before"には到達しません。', '1885': '1885は関数に渡した引数の値で、printされるのはreturnされた文字列です。', 'True': 'if文の条件式の結果ではなく、その条件で選ばれたreturn文の文字列が出力されます。' } },
  { id: 'fr_py_e03', languageId: 'python', world: 'execute', title: 'Lumiere brothers and early public cinema', titleJa: 'リュミエール兄弟と初期映画', category: 'film-history', objective: 'loop', source: SRC.lumiere, summaryJa: 'リュミエール兄弟は初期の公開映画上映と結びつけて語られます。', prompt: 'enumerate の番号と作品名を追い、出力を選んでください。', code: 'films = ["Arrival", "Factory"]\nlines = []\nfor index, title in enumerate(films, start=1):\n    lines.append(f"{index}:{title}")\nprint(",".join(lines))', options: ['1:Arrival,2:Factory', '0:Arrival,1:Factory', 'Arrival,Factory', '2:Arrival,1:Factory'], answer: '1:Arrival,2:Factory', expectedOutput: '1:Arrival,2:Factory', hint: 'enumerate(..., start=1) は番号を 1 から始めます。', explanation: '番号 1, 2 と各 title が組になり、join でカンマ区切りになります。', programmingExplanation: 'enumerate は添字と値を同時に取り出します。start を指定すると最初の番号を変えられます。', optionExplanations: { '1:Arrival,2:Factory': '正解。enumerate(films, start=1)により番号は1から始まり、Arrival=1, Factory=2になります。', '0:Arrival,1:Factory': 'start=1が指定されているため、番号は0からではなく1から始まります。', 'Arrival,Factory': 'f"{index}:{title}"で番号も文字列に含めているため、番号なしの出力にはなりません。', '2:Arrival,1:Factory': 'filmsの順番（Arrival→Factory）通りに番号が振られるので、番号が逆転することはありません。' } },
  { id: 'fr_py_e04', languageId: 'python', world: 'execute', title: 'Louis Braille and the Braille system', titleJa: 'ルイ・ブライユと点字', category: 'invention-accessibility', objective: 'dictionary', source: SRC.braille, summaryJa: 'ルイ・ブライユは点字体系の発展と結びつく人物です。', prompt: '入れ子データから値を取り出した結果を選んでください。', code: 'braille = {"cells": [{"dots": 6, "name": "basic cell"}]}\ncell = braille["cells"][0]\nprint(f"{cell[\'name\']}:{cell[\'dots\']}")', options: ['basic cell:6', 'cells:6', 'basic cell:dots', '6:basic cell'], answer: 'basic cell:6', expectedOutput: 'basic cell:6', hint: 'まず "cells" のリストから 0 番目を取り出します。', explanation: 'cell は辞書 {"dots": 6, "name": "basic cell"} になります。', programmingExplanation: '辞書とリストが入れ子になっているときは、外側から順にキーと添字をたどります。', optionExplanations: { 'basic cell:6': '正解。cell["name"]は"basic cell"、cell["dots"]は6なので、この順に連結されます。', 'cells:6': '"cells"はbraille辞書のキー名で、cellの値ではありません。出力にはcell["name"]の値が使われます。', 'basic cell:dots': 'f文字列の{cell[\'dots\']}は実際の値6に展開され、キー名の文字列"dots"が出力されることはありません。', '6:basic cell': 'f文字列は{cell[\'name\']}:{cell[\'dots\']}の順なので、nameが先、dotsが後になります。' } },
];

const pyDebug = [
  { id: 'fr_py_b01', languageId: 'python', world: 'debug', title: 'Fete de la Musique', titleJa: '音楽の日', category: 'culture-festival', objective: 'loop', source: SRC.fete, summaryJa: 'Fete de la Musique はフランス発祥の音楽イベントとして知られます。', prompt: '曲名リストをすべて表示したいコードです。境界条件の不具合を直します。', code: 'songs = ["street", "jazz", "choir"]\nfor i in range(len(songs) + 1):\n    print(songs[i])', cause: 'range(len(songs) + 1) が存在しない添字まで進む', fix: 'range(len(songs)) に修正する', impact: '3曲だけを安全に順番表示できる', why: '最後の有効な添字は len(songs) - 1 だからです。', correctedCode: 'songs = ["street", "jazz", "choir"]\nfor i in range(len(songs)):\n    print(songs[i])', hint: '最後に i が何になるかを見ます。', explanation: 'len + 1 により範囲外アクセスが起きます。', programmingExplanation: 'Python の range は終了値を含みませんが、len + 1 にすると len まで到達します。', causeOptionExplanations: { 'range(len(songs) + 1) が存在しない添字まで進む': '正解。songsは3件なのでrange(4)は0〜3を生成し、songs[3]は存在せずIndexErrorになります。', '出力文の文字列だけが間違っている': 'print(songs[i])自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'songsには3件のデータがあり、件数不足ではなくrangeの終了値が1つ多いことが原因です。' }, fixOptionExplanations: { 'range(len(songs)) に修正する': '正解。range(3)なら0,1,2だけを巡るので、存在する添字だけに安全にアクセスできます。', '条件を削除する': 'forの範囲指定を消すとrangeの引数がなくなり、そもそもコードが成立しません。', 'すべての値を同じ文字列にする': '曲名データを変えても、IndexErrorの原因であるrangeの終了値は直りません。' }, impactOptionExplanations: { '3曲だけを安全に順番表示できる': '正解。range(len(songs))により、存在する3件の添字だけを安全に処理できます。', '常に例外を出して停止する': '修正後はrangeの終了値が正しくなるため、IndexErrorは発生しなくなります。', '題材データを使わなくなる': 'songsのデータはそのまま使われ続けます。修正はrangeの範囲だけです。' } },
  { id: 'fr_py_b02', languageId: 'python', world: 'debug', title: 'French Republican calendar', titleJa: 'フランス共和暦', category: 'calendar-history', objective: 'dictionary', source: SRC.republicanCalendar, summaryJa: 'フランス共和暦は革命期に使われた独自の暦です。', prompt: '月番号から共和暦の月名を引くコードです。キーの対応を直します。', code: 'months = {1: "Vendemiaire", 2: "Brumaire"}\nmonth_number = 0\nprint(months[month_number])', cause: '辞書は 1 始まりのキーなのに 0 を参照している', fix: 'month_number = 1 に修正する', impact: '存在するキーから Vendemiaire を取得できる', why: '辞書のキーはデータで定義した番号に合わせる必要があります。', correctedCode: 'months = {1: "Vendemiaire", 2: "Brumaire"}\nmonth_number = 1\nprint(months[month_number])', hint: '辞書に存在するキーを確認します。', explanation: '0 というキーは months に存在しません。', programmingExplanation: '辞書アクセスでは存在しないキーを指定すると KeyError になります。', causeOptionExplanations: { '辞書は 1 始まりのキーなのに 0 を参照している': '正解。monthsのキーは1と2で、month_number=0というキーは存在しないためKeyErrorになります。', '出力文の文字列だけが間違っている': 'print(months[month_number])自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'monthsには1と2の2件のキーがあり、参照しているキー（0）が存在しないことが原因です。' }, fixOptionExplanations: { 'month_number = 1 に修正する': '正解。1はmonthsに存在するキーなので、Vendemiaireを正しく取得できます。', '条件を削除する': 'このコードにはif文などの条件はなく、削除すべき条件もありません。', 'すべての値を同じ文字列にする': '辞書の値を変えても、参照しているキー（0）が存在しない問題は直りません。' }, impactOptionExplanations: { '存在するキーから Vendemiaire を取得できる': '正解。month_number=1はmonthsに存在するキーなので、対応する値を正しく取得できます。', '常に例外を出して停止する': '修正後はキーが存在するようになるため、KeyErrorは発生しなくなります。', '題材データを使わなくなる': 'monthsのデータはそのまま使われ続けます。修正はmonth_numberの値だけです。' } },
  { id: 'fr_py_b03', languageId: 'python', world: 'debug', title: 'Limoges porcelain', titleJa: 'リモージュ磁器', category: 'craft', objective: 'strings', source: SRC.limoges, summaryJa: 'リモージュ磁器はフランスの陶磁器文化と結びつく工芸です。', prompt: '入力表記の大文字小文字が混ざっても判定できるようにします。', code: 'crafts = ["limoges porcelain", "glass"]\nname = "Limoges Porcelain"\nprint(name in crafts)', cause: '比較前に大文字小文字をそろえていない', fix: 'name.lower() in crafts に修正する', impact: '表記ゆれがあっても同じ工芸名として判定できる', why: 'リスト側が小文字なので、入力も小文字化して比較します。', correctedCode: 'crafts = ["limoges porcelain", "glass"]\nname = "Limoges Porcelain"\nprint(name.lower() in crafts)', hint: '文字列の形をそろえてから membership を見ます。', explanation: '大小文字が違う文字列はそのままでは一致しません。', programmingExplanation: 'lower() は文字列を小文字に変換します。in はリスト内に同じ値があるか調べます。', causeOptionExplanations: { '比較前に大文字小文字をそろえていない': '正解。craftsは小文字、nameは大文字混在のままinで比較しているため一致しません。', '出力文の文字列だけが間違っている': 'print(name in crafts)自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'craftsには2件のデータがあり、件数不足ではなく表記の不一致が原因です。' }, fixOptionExplanations: { 'name.lower() in crafts に修正する': '正解。nameを小文字化すればcrafts内の表記と一致し、正しく判定できます。', '条件を削除する': 'in による判定自体が目的なので、条件を削除すると判定の意味がなくなります。', 'すべての値を同じ文字列にする': 'craftsの値を変えても、nameの大文字小文字を揃えない限り判定は一致しません。' }, impactOptionExplanations: { '表記ゆれがあっても同じ工芸名として判定できる': '正解。lower()で表記を揃えることで、大文字小文字に関わらず正しく判定できます。', '常に例外を出して停止する': 'inによる判定はlower()を使ってもエラーにはならず、True/Falseを返すだけです。', '題材データを使わなくなる': 'craftsのデータはそのまま使われ続けます。修正はnameの比較方法だけです。' } },
];
...
const jsExecute = [
  { id: 'fr_js_e01', languageId: 'javascript', world: 'execute', title: 'Tour de France', titleJa: 'ツール・ド・フランス', category: 'sport', objective: 'loop', source: SRC.tour, summaryJa: 'ツール・ド・フランスはフランスを代表する自転車ロードレースです。', prompt: 'reduce で合計される距離を選んでください。', code: 'const stages = [120, 80, 100];\nconst total = stages.reduce((sum, km) => sum + km, 0);\nconsole.log(total);', options: ['300', '120', '200', '100'], answer: '300', expectedOutput: '300', hint: '0 から始めて3つの数を足します。', explanation: '120 + 80 + 100 = 300 です。', programmingExplanation: 'reduce は累積値を更新しながら配列を1つの値にまとめます。', optionExplanations: { '300': '正解。reduceの初期値0に120,80,100を順に足すと300になります。', '120': 'これはstagesの最初の要素だけの値で、reduceは3つすべてを合計します。', '200': '120+80=200は途中の合計で、最後の100をまだ足していません。', '100': 'これはstagesの最後の要素だけの値で、reduceは3つすべてを合計します。' } },
  { id: 'fr_js_e02', languageId: 'javascript', world: 'execute', title: 'Cannes Film Festival', titleJa: 'カンヌ映画祭', category: 'film-culture', objective: 'array', source: SRC.cannes, summaryJa: 'カンヌ映画祭はフランスの国際映画祭として知られます。', prompt: 'filter と map の結果を選んでください。', code: 'const films = [{title:"A", selected:true},{title:"B", selected:false},{title:"C", selected:true}];\nconsole.log(films.filter(f => f.selected).map(f => f.title).join("-"));', options: ['A-C', 'A-B-C', 'B', 'C-A'], answer: 'A-C', expectedOutput: 'A-C', hint: 'selected が true のものだけ残します。', explanation: 'A と C だけが残り、title を取り出して - で連結します。', programmingExplanation: 'filter は条件に合う要素を残し、map は各要素を別の値へ変換します。', optionExplanations: { 'A-C': '正解。selected:trueのAとCがfilterで残り、map後にA-Cとして連結されます。', 'A-B-C': 'Bはselected:falseなのでfilterで除外され、3件すべてが残ることはありません。', 'B': 'Bはselected:falseなのでfilterの条件を満たさず除外されます。', 'C-A': 'filter後も元の配列の順番（A→C）が保たれるため、C-Aの順にはなりません。' } },
  { id: 'fr_js_e03', languageId: 'javascript', world: 'execute', title: 'Paris Metro', titleJa: 'パリ・メトロ', category: 'transport', objective: 'object', source: SRC.metro, summaryJa: 'パリ・メトロはパリ都市交通の代表的な鉄道網です。', prompt: 'Object.entries の出力順を追ってください。', code: 'const lines = { one: "La Defense", four: "Bagneux" };\nconst labels = [];\nfor (const [line, end] of Object.entries(lines)) {\n  labels.push(`${line}:${end}`);\n}\nconsole.log(labels.join(","));', options: ['one:La Defense,four:Bagneux', 'four:Bagneux,one:La Defense', 'La Defense,Bagneux', 'one,four'], answer: 'one:La Defense,four:Bagneux', expectedOutput: 'one:La Defense,four:Bagneux', hint: 'オブジェクトに書かれた順で entries が処理されます。', explanation: 'one の組、four の組の順に labels へ追加されます。', programmingExplanation: 'Object.entries は [key, value] の配列を作り、for...of で順に取り出せます。', optionExplanations: { 'one:La Defense,four:Bagneux': '正解。Object.entriesはlinesに定義された順（one→four）でkey:valueの組を返します。', 'four:Bagneux,one:La Defense': 'linesオブジェクトはoneが先に定義されているため、entriesの順序もoneが先になります。', 'La Defense,Bagneux': 'テンプレートリテラルは`${line}:${end}`なので、key（line名）も必ず含まれます。', 'one,four': 'テンプレートリテラルにはendの値も含まれるため、keyだけが出力されることはありません。' } },
  { id: 'fr_js_e04', languageId: 'javascript', world: 'execute', title: 'Concorde supersonic aircraft', titleJa: 'コンコルド超音速機', category: 'aviation', objective: 'function', source: SRC.concorde, summaryJa: 'コンコルドは英仏共同開発の超音速旅客機として知られます。', prompt: '関数と条件の戻り値を選んでください。', code: 'function speedLabel(mach) {\n  return mach > 1 ? "supersonic" : "subsonic";\n}\nconsole.log(speedLabel(2));', options: ['supersonic', 'subsonic', '2', 'true'], answer: 'supersonic', expectedOutput: 'supersonic', hint: '2 > 1 の判定を見ます。', explanation: '条件が true なので "supersonic" が返ります。', programmingExplanation: '三項演算子は 条件 ? trueの値 : falseの値 で結果を選びます。', optionExplanations: { 'supersonic': '正解。mach(2) > 1 がtrueなので三項演算子は"supersonic"を返します。', 'subsonic': '"subsonic"はmach > 1がfalseの場合の値で、今回mach=2なのでtrue側が選ばれます。', '2': '2はmachに渡した引数の値で、返されるのは三項演算子で選ばれた文字列です。', 'true': '三項演算子の条件式の結果ではなく、その結果に応じて選ばれた文字列が出力されます。' } },
];

const jsDebug = [
  { id: 'fr_js_b01', languageId: 'javascript', world: 'debug', title: 'French telephone-number formatting', titleJa: 'フランスの電話番号表記', category: 'administration', objective: 'strings', source: SRC.telephone, summaryJa: 'フランスの電話番号は桁数や区切りをそろえて扱う必要があります。', prompt: '10桁の番号を2桁ごとに区切りたいコードです。', code: 'const digits = "0123456789";\nconst formatted = digits.match(/.{1,3}/g).join(" ");\nconsole.log(formatted);', cause: '2桁ごとではなく3桁ごとに分割している', fix: '正規表現を /.{1,2}/g に修正する', impact: '01 23 45 67 89 のように2桁区切りになる', why: '量指定子の 2 が1グループの最大文字数を表します。', correctedCode: 'const digits = "0123456789";\nconst formatted = digits.match(/.{1,2}/g).join(" ");\nconsole.log(formatted);', hint: 'match の正規表現が何文字ずつ拾うかを見ます。', explanation: '3文字区切りでは電話番号の表示と合いません。', programmingExplanation: '正規表現の .{1,2} は1から2文字のまとまりを探します。', causeOptionExplanations: { '2桁ごとではなく3桁ごとに分割している': '正解。/.{1,3}/gは最大3文字ずつ拾うため、フランス式の2桁区切りにはなりません。', '出力文の文字列だけが間違っている': 'console.log(formatted)自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'digitsには10桁すべてが含まれており、件数不足ではなく正規表現の桁数指定が原因です。' }, fixOptionExplanations: { '正規表現を /.{1,2}/g に修正する': '正解。{1,2}にすることで最大2文字ずつのグループに分割されます。', '条件を削除する': '正規表現を削除するとmatchが機能せず、桁の分割自体ができなくなります。', 'すべての値を同じ文字列にする': 'digitsの内容を変えても、3桁区切りになる正規表現自体は直りません。' }, impactOptionExplanations: { '01 23 45 67 89 のように2桁区切りになる': '正解。{1,2}への変更で2桁ずつのグループに区切られ、フランス式の表記になります。', '常に例外を出して停止する': '正規表現を{1,2}に変えてもmatchは正常に動作し、例外は発生しません。', '題材データを使わなくなる': 'digitsの値はそのまま使われ続けます。修正は正規表現の桁数指定だけです。' } },
  { id: 'fr_js_b02', languageId: 'javascript', world: 'debug', title: 'Normandy landing beaches', titleJa: 'ノルマンディー上陸作戦の海岸', category: 'history', objective: 'loop', source: SRC.normandy, summaryJa: 'ノルマンディーの上陸海岸は第二次世界大戦史と結びつく場所です。', prompt: '対象の beach を見つけたら止めるコードです。', code: 'const beaches = ["Utah", "Omaha", "Gold"];\nlet found = "";\nfor (let i = 0; i <= beaches.length; i++) {\n  if (beaches[i] === "Omaha") found = beaches[i];\n}\nconsole.log(found);', cause: 'i <= beaches.length で範囲外まで読む可能性がある', fix: 'i < beaches.length に修正する', impact: '存在する要素だけを安全に確認できる', why: '配列の最後の添字は length - 1 です。', correctedCode: 'const beaches = ["Utah", "Omaha", "Gold"];\nlet found = "";\nfor (let i = 0; i < beaches.length; i++) {\n  if (beaches[i] === "Omaha") found = beaches[i];\n}\nconsole.log(found);', hint: '配列の最後の添字を確認します。', explanation: 'length と同じ添字は存在しません。', programmingExplanation: 'for ループの境界条件は配列アクセスの安全性に直結します。', causeOptionExplanations: { 'i <= beaches.length で範囲外まで読む可能性がある': '正解。beaches.lengthは3なのでi<=3だとi=3でbeaches[3]という存在しない添字を読みます。', '出力文の文字列だけが間違っている': 'console.log(found)自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'beachesには3件のデータがあり、件数不足ではなくループの境界条件が原因です。' }, fixOptionExplanations: { 'i < beaches.length に修正する': '正解。i<3にすることでi=0,1,2の範囲内だけを安全に読み取れます。', '条件を削除する': 'forの条件を削除すると無限ループになり、配列アクセスの安全性も確保できません。', 'すべての値を同じ文字列にする': 'beachesの内容を変えても、ループの境界条件が範囲外を指す問題は直りません。' }, impactOptionExplanations: { '存在する要素だけを安全に確認できる': '正解。i < beaches.lengthにより、存在する3件の添字だけを安全に確認できます。', '常に例外を出して停止する': '修正後はループの境界が正しくなるため、範囲外アクセスは発生しなくなります。', '題材データを使わなくなる': 'beachesのデータはそのまま使われ続けます。修正はループの境界条件だけです。' } },
  { id: 'fr_js_b03', languageId: 'javascript', world: 'debug', title: 'Guiana Space Centre', titleJa: 'ギアナ宇宙センター', category: 'space', objective: 'object', source: SRC.guiana, summaryJa: 'ギアナ宇宙センターは欧州の宇宙打ち上げ拠点として知られます。', prompt: '施設データがない場合でも安全に表示したいコードです。', code: 'const center = { name: "Guiana Space Centre" };\nconsole.log(center.location.city.toUpperCase());', cause: '存在しない location プロパティの中を読もうとしている', fix: 'center.location?.city ?? "unknown" のように安全に読む', impact: '欠けているデータでも例外で止まらない', why: 'optional chaining は途中が undefined のとき undefined を返します。', correctedCode: 'const center = { name: "Guiana Space Centre" };\nconst city = center.location?.city ?? "unknown";\nconsole.log(city);', hint: 'location があるかどうかを先に考えます。', explanation: 'undefined の city を読むと TypeError になります。', programmingExplanation: '?. と ?? を組み合わせると、欠損データを安全に扱えます。', causeOptionExplanations: { '存在しない location プロパティの中を読もうとしている': '正解。centerにはlocationが定義されておらず、undefinedのcityを読もうとしてTypeErrorになります。', '出力文の文字列だけが間違っている': 'console.log自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'centerにはnameプロパティがあり、件数不足ではなくlocationが未定義であることが原因です。' }, fixOptionExplanations: { 'center.location?.city ?? "unknown" のように安全に読む': '正解。?.でlocationが無くてもエラーにならず、??でデフォルト値"unknown"を補えます。', '条件を削除する': 'このコードにはif文などの条件はなく、削除すべき条件もありません。', 'すべての値を同じ文字列にする': 'centerのデータを変えても、location未定義時に安全に読む処理がない限り同じ問題が起きます。' }, impactOptionExplanations: { '欠けているデータでも例外で止まらない': '正解。optional chainingとnullish coalescingにより、locationが無くてもエラーにならず処理が続きます。', '常に例外を出して停止する': '修正後は?.と??により安全に読めるようになるため、TypeErrorは発生しなくなります。', '題材データを使わなくなる': 'centerのデータはそのまま使われ続けます。修正はlocationへの安全なアクセス方法だけです。' } },
];
...
const javaExecute = [
  { id: 'fr_java_e01', languageId: 'java', world: 'execute', title: 'Champagne hillsides houses and cellars', titleJa: 'シャンパーニュの丘陵・メゾンとカーヴ', category: 'world-heritage-food', objective: 'array', source: SRC.champagne, summaryJa: 'シャンパーニュの景観はワイン文化と結びつく世界遺産です。', prompt: 'enhanced for で連結される出力を選んでください。', code: 'public class Main {\n  public static void main(String[] args) {\n    String[] words = {"hillsides", "houses", "cellars"};\n    String result = "";\n    for (String word : words) result += word.charAt(0);\n    System.out.println(result);\n  }\n}', options: ['hhc', 'hHC', 'hillsideshousescellars', 'chh'], answer: 'hhc', expectedOutput: 'hhc', hint: '各単語の先頭文字だけを足します。', explanation: 'h, h, c が順に追加されます。', programmingExplanation: 'enhanced for は配列の値を順に取り出し、charAt(0) は先頭文字を返します。', optionExplanations: { 'hhc': '正解。hillsides→h、houses→h、cellars→cの先頭文字を順に連結するとhhcになります。', 'hHC': 'charAt(0)は元の文字をそのまま返すだけで、大文字化は行われないため全て小文字のままです。', 'hillsideshousescellars': 'charAt(0)で各単語の先頭1文字だけを取り出しているので、単語全体が連結されることはありません。', 'chh': 'wordsの順序（hillsides→houses→cellars）通りに処理されるため、先頭がcになることはありません。' } },
  { id: 'fr_java_e02', languageId: 'java', world: 'execute', title: 'Ariane launch vehicle', titleJa: 'アリアンロケット', category: 'space-industry', objective: 'condition', source: SRC.ariane, summaryJa: 'アリアンは欧州の宇宙輸送を支える打ち上げ機シリーズです。', prompt: '条件分岐の結果を選んでください。', code: 'public class Main {\n  public static void main(String[] args) {\n    int payload = 5;\n    if (payload >= 5) System.out.println("launch-ready");\n    else System.out.println("hold");\n  }\n}', options: ['launch-ready', 'hold', '5', 'true'], answer: 'launch-ready', expectedOutput: 'launch-ready', hint: '5 >= 5 は true です。', explanation: '条件が true なので最初の println が実行されます。', programmingExplanation: '比較演算子 >= は左辺が右辺以上かを調べます。', optionExplanations: { 'launch-ready': '正解。payload(5) >= 5 がtrueなので最初のprintln("launch-ready")が実行されます。', 'hold': '"hold"はelse側の出力で、今回は条件がtrueなので実行されません。', '5': '5はpayloadの値であり、画面に出力されるのはif/elseで選ばれた文字列です。', 'true': '条件式の評価結果ではなく、その条件で選ばれたprintlnの文字列が出力されます。' } },
  { id: 'fr_java_e03', languageId: 'java', world: 'execute', title: 'Airbus in Toulouse', titleJa: 'トゥールーズとエアバス', category: 'aviation-industry', objective: 'object', source: SRC.airbus, summaryJa: 'トゥールーズはエアバス産業と強く結びつく都市です。', prompt: 'オブジェクトのフィールド出力を選んでください。', code: 'class Maker { String city; Maker(String city){ this.city = city; } }\npublic class Main {\n  public static void main(String[] args) {\n    Maker airbus = new Maker("Toulouse");\n    System.out.println("Airbus:" + airbus.city);\n  }\n}', options: ['Airbus:Toulouse', 'Toulouse:Airbus', 'Airbus:null', 'Maker:Toulouse'], answer: 'Airbus:Toulouse', expectedOutput: 'Airbus:Toulouse', hint: 'constructor が city フィールドに値を入れます。', explanation: 'new Maker("Toulouse") により city が Toulouse になります。', programmingExplanation: 'コンストラクタ内の this.city は作成したオブジェクトのフィールドを指します。', optionExplanations: { 'Airbus:Toulouse': '正解。コードは"Airbus:" + airbus.cityで、cityはコンストラクタでToulouseに設定されています。', 'Toulouse:Airbus': '連結の順番は"Airbus:" + airbus.cityなので、Airbusが先、cityの値が後になります。', 'Airbus:null': 'new Maker("Toulouse")によりcityはToulouseに初期化されており、nullのままではありません。', 'Maker:Toulouse': '文字列リテラルは"Airbus:"で、クラス名Makerが出力されることはありません。' } },
  { id: 'fr_java_e04', languageId: 'java', world: 'execute', title: 'Dordogne river valley', titleJa: 'ドルドーニュ渓谷', category: 'geography', objective: 'loop', source: SRC.dordogne, summaryJa: 'ドルドーニュ地方は河川景観や歴史的集落で知られます。', prompt: '合計される値を選んでください。', code: 'public class Main {\n  public static void main(String[] args) {\n    int[] visits = {2, 3, 4};\n    int total = 0;\n    for (int v : visits) total += v;\n    System.out.println(total);\n  }\n}', options: ['9', '6', '4', '234'], answer: '9', expectedOutput: '9', hint: '2 + 3 + 4 を計算します。', explanation: 'total は 0 から始まり、各値が足されて 9 になります。', programmingExplanation: 'int 配列の値を enhanced for で順に取り出し、累積変数に加えます。', optionExplanations: { '9': '正解。total=0に2,3,4を順に足すと9になります。', '6': 'これは3+4の値で、最初の2をまだ足していません。', '4': 'これはvisitsの最後の要素だけの値で、合計は3つすべてを足します。', '234': '+=は数値の足し算で、文字列のように数字を連結することはありません。' } },
];

const javaDebug = [
  { id: 'fr_java_b01', languageId: 'java', world: 'debug', title: 'Musee d Orsay', titleJa: 'オルセー美術館', category: 'museum', objective: 'strings', source: SRC.orsay, summaryJa: 'オルセー美術館は近代美術を中心に収蔵するパリの美術館です。', prompt: '美術館名の文字列比較を直します。', code: 'public class Main {\n  public static void main(String[] args) {\n    String museum = new String("Orsay");\n    System.out.println(museum == "Orsay");\n  }\n}', cause: 'String の内容比較に == を使っている', fix: 'museum.equals("Orsay") に修正する', impact: '文字列の中身が同じか正しく判定できる', why: '== は参照の同一性を比較するためです。', correctedCode: 'public class Main {\n  public static void main(String[] args) {\n    String museum = new String("Orsay");\n    System.out.println(museum.equals("Orsay"));\n  }\n}', hint: 'Java の String 比較方法を思い出します。', explanation: '== では参照が違うと false になります。', programmingExplanation: 'equals はオブジェクトが表す内容を比較します。', causeOptionExplanations: { 'String の内容比較に == を使っている': '正解。new String("Orsay")は新しい参照を作るため、==では文字列リテラルと参照が異なりfalseになります。', '出力文の文字列だけが間違っている': 'System.out.println自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'museumには"Orsay"という値が入っており、件数不足ではなく比較方法が原因です。' }, fixOptionExplanations: { 'museum.equals("Orsay") に修正する': '正解。equalsは文字列の内容を比較するため、参照が違っても中身が同じならtrueになります。', '条件を削除する': '比較自体が目的なので、条件を削除すると判定の意味がなくなります。', 'すべての値を同じ文字列にする': 'museumの値を変えても、==による参照比較という問題自体は直りません。' }, impactOptionExplanations: { '文字列の中身が同じか正しく判定できる': '正解。equalsを使うことで、参照に関わらず文字列の内容で正しく判定できます。', '常に例外を出して停止する': 'equalsへの変更で例外が発生するようになるわけではなく、正しくtrue/falseが返ります。', '題材データを使わなくなる': 'museumのデータはそのまま使われ続けます。修正は比較方法だけです。' } },
  { id: 'fr_java_b02', languageId: 'java', world: 'debug', title: 'Sorbonne University', titleJa: 'ソルボンヌ大学', category: 'education-history', objective: 'array', source: SRC.sorbonne, summaryJa: 'ソルボンヌはパリの高等教育史と結びつく名称です。', prompt: '学部名配列を安全に表示するループを直します。', code: 'public class Main {\n  public static void main(String[] args) {\n    String[] faculties = {"Arts", "Science"};\n    for (int i = 0; i <= faculties.length; i++) System.out.println(faculties[i]);\n  }\n}', cause: 'i <= faculties.length で範囲外の添字に到達する', fix: 'i < faculties.length に修正する', impact: '配列内の要素だけを表示できる', why: '最後の添字は length - 1 です。', correctedCode: 'public class Main {\n  public static void main(String[] args) {\n    String[] faculties = {"Arts", "Science"};\n    for (int i = 0; i < faculties.length; i++) System.out.println(faculties[i]);\n  }\n}', hint: '配列の長さと最後の添字は同じではありません。', explanation: 'length と同じ添字は範囲外です。', programmingExplanation: '配列走査の基本条件は i < array.length です。', causeOptionExplanations: { 'i <= faculties.length で範囲外の添字に到達する': '正解。faculties.lengthは2なのでi<=2だとi=2でfaculties[2]という存在しない添字に到達します。', '出力文の文字列だけが間違っている': 'System.out.println自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'facultiesには2件のデータがあり、件数不足ではなくループの境界条件が原因です。' }, fixOptionExplanations: { 'i < faculties.length に修正する': '正解。i<2にすることでi=0,1の範囲内だけを安全に表示できます。', '条件を削除する': 'forの条件を削除すると無限ループになり、配列アクセスの安全性も確保できません。', 'すべての値を同じ文字列にする': 'facultiesの内容を変えても、ループの境界条件が範囲外を指す問題は直りません。' }, impactOptionExplanations: { '配列内の要素だけを表示できる': '正解。i < faculties.lengthにより、存在する2件の添字だけを安全に表示できます。', '常に例外を出して停止する': '修正後はループの境界が正しくなるため、範囲外アクセスは発生しなくなります。', '題材データを使わなくなる': 'facultiesのデータはそのまま使われ続けます。修正はループの境界条件だけです。' } },
  { id: 'fr_java_b03', languageId: 'java', world: 'debug', title: 'Marianne symbol', titleJa: 'マリアンヌ', category: 'national-symbol', objective: 'object', source: SRC.marianne, summaryJa: 'マリアンヌはフランス共和国を象徴する女性像です。', prompt: '欠けた説明データでも安全に扱うコードへ直します。', code: 'class SymbolData { String note; }\npublic class Main {\n  public static void main(String[] args) {\n    SymbolData data = new SymbolData();\n    System.out.println(data.note.toUpperCase());\n  }\n}', cause: 'note が null のままメソッドを呼んでいる', fix: 'null チェックをしてから toUpperCase() を呼ぶ', impact: '説明が未設定でも NullPointerException を防げる', why: 'null にはメソッドを呼び出せません。', correctedCode: 'class SymbolData { String note; }\npublic class Main {\n  public static void main(String[] args) {\n    SymbolData data = new SymbolData();\n    if (data.note != null) System.out.println(data.note.toUpperCase());\n    else System.out.println("UNKNOWN");\n  }\n}', hint: 'フィールドの初期値を確認します。', explanation: '参照型フィールドは明示的に入れないと null です。', programmingExplanation: 'null チェックにより、存在しないオブジェクトへのメソッド呼び出しを避けます。', causeOptionExplanations: { 'note が null のままメソッドを呼んでいる': '正解。noteは初期化されておらずnullのままで、null.toUpperCase()はNullPointerExceptionになります。', '出力文の文字列だけが間違っている': 'System.out.println自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'これは件数の問題ではなく、noteフィールドがnullのまま使われていることが原因です。' }, fixOptionExplanations: { 'null チェックをしてから toUpperCase() を呼ぶ': '正解。data.note != nullを確認してから呼ぶことで、nullに対するメソッド呼び出しを避けられます。', '条件を削除する': '条件（nullチェック）を削除すると、nullに対する呼び出しを防ぐ手段がなくなります。', 'すべての値を同じ文字列にする': 'noteの値を変えても、nullチェックを入れない限り未設定時の問題は直りません。' }, impactOptionExplanations: { '説明が未設定でも NullPointerException を防げる': '正解。nullチェックにより、noteが未設定の場合でも安全に"UNKNOWN"などを表示できます。', '常に例外を出して停止する': '修正後はnullチェックがあるため、例外は発生しなくなります。', '題材データを使わなくなる': 'SymbolDataの構造はそのまま使われ続けます。修正はnullチェックの追加だけです。' } },
];
...
const pyFinalExecute = [
  { id: 'final_execute_FR_python_01', languageId: 'python', world: 'execute', title: 'Origins of the metric system in revolutionary France', titleJa: '革命期フランスとメートル法', category: 'science-standards', objective: 'dictionary', source: SRC.metric, summaryJa: 'メートル法は革命期フランスの標準化の流れと結びついて発展しました。', prompt: '辞書とリスト処理で合計される値を選んでください。', code: 'units = [{"name": "metre", "base": True}, {"name": "litre", "base": False}, {"name": "gram", "base": True}]\ncount = sum(1 for unit in units if unit["base"])\nprint(count)', options: ['2', '3', '1', 'metre'], answer: '2', expectedOutput: '2', hint: 'base が True の辞書だけ数えます。', explanation: 'metre と gram の2件が条件に合います。', programmingExplanation: 'ジェネレータ式を sum に渡すと、条件に合う件数を数えられます。', optionExplanations: { '2': '正解。base:Trueなのはmetreとgramの2件なので、sumは2になります。', '3': 'unitsは3件ありますが、baseがTrueなのはmetreとgramの2件だけです。litreはbase:Falseです。', '1': 'metreとgramの両方がbase:Trueなので、1件だけではありません。', 'metre': 'sumは件数（整数）を返すもので、要素の名前の文字列が出力されるわけではありません。' } },
  { id: 'final_execute_FR_python_02', languageId: 'python', world: 'execute', title: 'TGV service', titleJa: 'TGV', category: 'transport', objective: 'list', source: SRC.tgv, summaryJa: 'TGV はフランスの高速鉄道サービスとして知られます。', prompt: '速度条件で絞り、速い順に並べた結果を選んでください。', code: 'trains = [{"name":"A","speed":300},{"name":"B","speed":260},{"name":"C","speed":320}]\nfast = [t for t in trains if t["speed"] >= 300]\nfast.sort(key=lambda t: t["speed"], reverse=True)\nprint("-".join(t["name"] for t in fast))', options: ['C-A', 'A-C', 'A-B-C', 'B-A'], answer: 'C-A', expectedOutput: 'C-A', hint: '300以上を残し、速度の降順です。', explanation: 'C(320), A(300) の順に残ります。', programmingExplanation: 'リスト内包表記で絞り込み、sort の key と reverse で順序を指定します。', optionExplanations: { 'C-A': '正解。speed>=300で残るのはA(300)とC(320)で、reverse=Trueの降順だとC(320)が先になります。', 'A-C': 'sortはreverse=Trueで降順なので、speedが大きいC(320)がA(300)より先になります。', 'A-B-C': 'Bはspeed=260で300以上の条件を満たさないため、fastリストには入りません。', 'B-A': 'Bはspeed=260で300以上の条件を満たさないため、そもそもfastに含まれません。' } },
];

const pyFinalDebug = [
  { id: 'final_debug_FR_python_01', languageId: 'python', world: 'debug', title: 'Burgundy vineyard climats', titleJa: 'ブルゴーニュのクリマ', category: 'world-heritage-wine', objective: 'dictionary', source: SRC.burgundy, summaryJa: 'ブルゴーニュのクリマはブドウ畑の区画とワイン文化を示す世界遺産です。', prompt: '面積データを数値化し、欠損を安全に扱うコードです。', code: 'records = [{"name": "A", "area": "12.5"}, {"name": "B"}]\nlarge = []\nfor record in records:\n    if float(record["area"]) > 10:\n        large.append(record["name"])\nprint(large)', cause: 'area がない辞書でも record["area"] を読んでいる', fix: 'record.get("area") を確認してから float に変換する', impact: '欠損行を飛ばし、数値化できる行だけ判定できる', why: 'get はキーがない場合に None を返せます。', correctedCode: 'records = [{"name": "A", "area": "12.5"}, {"name": "B"}]\nlarge = []\nfor record in records:\n    area = record.get("area")\n    if area is not None and float(area) > 10:\n        large.append(record["name"])\nprint(large)', hint: 'B の辞書に area キーがありません。', explanation: '欠損キーを直接読むと KeyError になります。', programmingExplanation: 'get と None 判定を使うと、欠損データを含む一覧を安全に処理できます。', causeOptionExplanations: { 'area がない辞書でも record["area"] を読んでいる': '正解。Bの辞書にはareaキーが無く、record["area"]で直接読むとKeyErrorになります。', '出力文の文字列だけが間違っている': 'print(large)自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'recordsには2件のデータがあり、件数不足ではなくBにareaキーが無いことが原因です。' }, fixOptionExplanations: { 'record.get("area") を確認してから float に変換する': '正解。getはキーが無い場合Noneを返すので、None判定をしてから安全にfloat変換できます。', '条件を削除する': 'if文の条件を削除すると、area>10かどうかの絞り込み自体ができなくなります。', 'すべての値を同じ文字列にする': 'recordsの値を変えても、areaキーが無い行を直接読む問題自体は直りません。' }, impactOptionExplanations: { '欠損行を飛ばし、数値化できる行だけ判定できる': '正解。Noneチェックにより、areaが無い行を安全にスキップして処理できます。', '常に例外を出して停止する': '修正後はgetとNone判定があるため、KeyErrorは発生しなくなります。', '題材データを使わなくなる': 'recordsのデータはそのまま使われ続けます。修正はareaの読み取り方法だけです。' } },
];
...
const jsFinalExecute = [
  { id: 'final_execute_FR_javascript_01', languageId: 'javascript', world: 'execute', title: 'Cite des sciences et de l industrie', titleJa: 'シテ科学産業博物館', category: 'science-museum', objective: 'array', source: SRC.citeScience, summaryJa: 'シテ科学産業博物館はパリの科学展示施設です。', prompt: '条件で絞り、名前をソートした結果を選んでください。', code: 'const halls = [{name:"Space", open:true}, {name:"Math", open:true}, {name:"Archive", open:false}];\nconst names = halls.filter(h => h.open).map(h => h.name).sort();\nconsole.log(names.join("-"));', options: ['Math-Space', 'Space-Math', 'Archive-Math-Space', 'Space'], answer: 'Math-Space', expectedOutput: 'Math-Space', hint: 'open が true のものだけ残し、アルファベット順です。', explanation: 'Math と Space が残り、sort で Math が先です。', programmingExplanation: 'filter, map, sort を順に適用して配列を変換します。', optionExplanations: { 'Math-Space': '正解。open:trueのSpaceとMathが残り、デフォルトのsort（アルファベット順）でMathが先になります。', 'Space-Math': 'sort()は引数なしだとアルファベット順なので、M（Math）がS（Space）より先になります。', 'Archive-Math-Space': 'Archiveはopen:falseなのでfilterで除外され、3件すべてが残ることはありません。', 'Space': 'open:trueなのはSpaceとMathの2件で、Mathも残るため1件だけにはなりません。' } },
  { id: 'final_execute_FR_javascript_02', languageId: 'javascript', world: 'execute', title: 'Paris Agreement', titleJa: 'パリ協定', category: 'environment', objective: 'array', source: SRC.parisAgreement, summaryJa: 'パリ協定は気候変動対策の国際的な枠組みです。', prompt: '入れ子配列を reduce で合計した結果を選んでください。', code: 'const groups = [{region:"A", pledges:[1,2]}, {region:"B", pledges:[3]}];\nconst total = groups.reduce((sum, group) => sum + group.pledges.reduce((a,b) => a + b, 0), 0);\nconsole.log(total);', options: ['6', '3', '2', 'A-B'], answer: '6', expectedOutput: '6', hint: '内側の配列も合計します。', explanation: 'A は 3、B は 3、合計 6 です。', programmingExplanation: 'reduce を入れ子にすると、グループごとの合計と全体合計を順に作れます。', optionExplanations: { '6': '正解。Aのpledges[1,2]の合計3とBのpledges[3]の合計3を足すと6になります。', '3': 'これはAまたはBの片方だけの合計で、外側のreduceは両グループを足し合わせます。', '2': 'これはAのpledgesの最初の要素だけの値で、内側・外側どちらのreduceでも合計されません。', 'A-B': 'reduceは数値の合計を計算するもので、region名の文字列を連結することはありません。' } },
];

const jsFinalDebug = [
  { id: 'final_debug_FR_javascript_01', languageId: 'javascript', world: 'debug', title: 'Palace of Fontainebleau', titleJa: 'フォンテーヌブロー宮殿', category: 'world-heritage', objective: 'object', source: SRC.fontainebleau, summaryJa: 'フォンテーヌブロー宮殿は長い王室史を持つフランスの宮殿です。', prompt: 'プロパティ名と安全なアクセスを直します。', code: 'const site = { name: "Fontainebleau", kind: "palace" };\nif (site.type === "palace") console.log(site.name.toUpperCase());\nconsole.log(site.details.city);', cause: 'type という存在しないプロパティと details の未確認アクセスがある', fix: 'site.kind を比較し、site.details?.city のように安全に読む', impact: '正しいプロパティで判定し、欠損データでも停止しない', why: '存在しないプロパティは undefined になります。', correctedCode: 'const site = { name: "Fontainebleau", kind: "palace" };\nif (site.kind === "palace") console.log(site.name.toUpperCase());\nconsole.log(site.details?.city ?? "unknown");', hint: 'オブジェクトに実際にあるキーを確認します。', explanation: 'kind が正しいキーで、details は存在確認が必要です。', programmingExplanation: 'strict comparison と optional chaining を組み合わせると、安全に object を扱えます。', causeOptionExplanations: { 'type という存在しないプロパティと details の未確認アクセスがある': '正解。siteにはtypeもdetailsも定義されておらず、site.type===は常にfalse、site.details.cityはTypeErrorになります。', '出力文の文字列だけが間違っている': 'console.log自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'siteにはnameとkindが定義されており、件数の問題ではなくプロパティ名と未確認アクセスが原因です。' }, fixOptionExplanations: { 'site.kind を比較し、site.details?.city のように安全に読む': '正解。実際に存在するkindで判定し、?.でdetailsが無くてもエラーを防げます。', '条件を削除する': '判定自体が目的なので、条件を削除するとpalaceかどうかの判定ができなくなります。', 'すべての値を同じ文字列にする': 'siteの値を変えても、誤ったプロパティ名と未確認アクセスという問題自体は直りません。' }, impactOptionExplanations: { '正しいプロパティで判定し、欠損データでも停止しない': '正解。kindでの正しい判定と?.による安全なアクセスで、欠損データがあっても処理が止まりません。', '常に例外を出して停止する': '修正後はoptional chainingがあるため、TypeErrorは発生しなくなります。', '題材データを使わなくなる': 'siteのデータはそのまま使われ続けます。修正はプロパティ名とアクセス方法だけです。' } },
];
...
const javaFinalExecute = [
  { id: 'final_execute_FR_java_01', languageId: 'java', world: 'execute', title: 'Chateau de Chambord', titleJa: 'シャンボール城', category: 'architecture', objective: 'object', source: SRC.chateaux, summaryJa: 'シャンボール城はロワール地方を代表する城館の一つです。', prompt: 'オブジェクト一覧を条件で選び、出力される名前を選んでください。', code: 'import java.util.ArrayList;\nclass Castle { String name; int towers; Castle(String n, int t){ name=n; towers=t; } }\npublic class Main {\n  public static void main(String[] args) {\n    ArrayList<Castle> castles = new ArrayList<>();\n    castles.add(new Castle("Chambord", 4)); castles.add(new Castle("Small", 1));\n    for (Castle castle : castles) if (castle.towers >= 4) System.out.println(castle.name);\n  }\n}', options: ['Chambord', 'Small', '4', 'Chambord Small'], answer: 'Chambord', expectedOutput: 'Chambord', hint: 'towers が 4 以上の object だけです。', explanation: 'Chambord だけが条件を満たします。', programmingExplanation: 'クラスのフィールドを条件に使い、ArrayList を走査します。', optionExplanations: { 'Chambord': '正解。towers=4の城はChambordだけで、towers >= 4の条件を満たすのでnameが出力されます。', 'Small': 'SmallのtowersはNo（1）で4未満なので、if (castle.towers >= 4)の条件を満たしません。', '4': '4はChambordのtowersフィールドの値で、出力されるのはcastle.name（城の名前）です。', 'Chambord Small': '条件を満たすのはChambordだけなので、Smallが一緒に出力されることはありません。' } },
  { id: 'final_execute_FR_java_02', languageId: 'java', world: 'execute', title: 'French social security', titleJa: 'フランスの社会保障', category: 'public-system', objective: 'map', source: SRC.secu, summaryJa: 'フランスの社会保障制度は医療や年金などの分野を支える仕組みです。', prompt: 'HashMap とループで合計される値を選んでください。', code: 'import java.util.HashMap;\npublic class Main {\n  public static void main(String[] args) {\n    HashMap<String,Integer> branches = new HashMap<>();\n    branches.put("health", 2); branches.put("pension", 3);\n    int total = 0;\n    for (int value : branches.values()) total += value;\n    System.out.println(total);\n  }\n}', options: ['5', '2', '3', 'healthpension'], answer: '5', expectedOutput: '5', hint: 'values() の数値をすべて足します。', explanation: '2 + 3 = 5 です。', programmingExplanation: 'HashMap.values() は値の collection を返し、for で合計できます。', optionExplanations: { '5': '正解。values()はhealthの2とpensionの3を含み、totalはそれらを足して5になります。', '2': 'これはhealthの値だけで、forループはvalues()のすべての値（healthとpension）を合計します。', '3': 'これはpensionの値だけで、forループはvalues()のすべての値（healthとpension）を合計します。', 'healthpension': 'totalはint型でvaluesの数値を合計するもので、キー名の文字列が連結されることはありません。' } },
];

const javaFinalDebug = [
  { id: 'final_debug_FR_java_01', languageId: 'java', world: 'debug', title: 'Guadeloupe archipelago', titleJa: 'グアドループ', category: 'overseas-geography', objective: 'object', source: SRC.guadeloupe, summaryJa: 'グアドループはカリブ海にあるフランスの海外地域です。', prompt: '数値文字列と欠損データを安全に扱うコードへ直します。', code: 'public class Main {\n  public static void main(String[] args) {\n    String area = "1,628 km2";\n    int value = Integer.parseInt(area);\n    System.out.println(value);\n  }\n}', cause: '単位とカンマを含む文字列をそのまま整数化している', fix: '数字以外を取り除いてから parseInt し、例外にも備える', impact: '表示用文字列から必要な数値だけを安全に取り出せる', why: 'parseInt は純粋な数字文字列だけを受け付けます。', correctedCode: 'public class Main {\n  public static void main(String[] args) {\n    String area = "1,628 km2";\n    try {\n      int value = Integer.parseInt(area.replaceAll("[^0-9]", ""));\n      System.out.println(value);\n    } catch (NumberFormatException e) {\n      System.out.println("unknown");\n    }\n  }\n}', hint: 'parseInt に渡す前の文字列を確認します。', explanation: 'カンマや単位があると NumberFormatException になります。', programmingExplanation: 'replaceAll で不要な文字を除去し、try/catch で変換失敗に備えます。', causeOptionExplanations: { '単位とカンマを含む文字列をそのまま整数化している': '正解。"1,628 km2"にはカンマと単位が含まれ、parseIntは純粋な数字文字列以外を受け付けずNumberFormatExceptionになります。', '出力文の文字列だけが間違っている': 'System.out.println自体は正しく書けており、出力文の指定ミスではありません。', 'データの件数が不足している': 'areaには値が1つ入っており、件数の問題ではなく文字列の形式が原因です。' }, fixOptionExplanations: { '数字以外を取り除いてから parseInt し、例外にも備える': '正解。replaceAllで数字以外を除去してからparseIntすることで、安全に整数値を取り出せます。', '条件を削除する': 'このコードには元々if文などの条件はなく、削除すべき条件もありません。', 'すべての値を同じ文字列にする': 'areaの値を変えても、カンマや単位を含む文字列をそのまま整数化する問題自体は直りません。' }, impactOptionExplanations: { '表示用文字列から必要な数値だけを安全に取り出せる': '正解。不要な文字を除去してからparseIntすることで、表示用の文字列からも数値だけを安全に取り出せます。', '常に例外を出して停止する': '修正後はreplaceAllとtry/catchがあるため、想定内の文字列であれば例外で停止しません。', '題材データを使わなくなる': 'areaのデータはそのまま使われ続けます。修正は数値への変換方法だけです。' } },
];
