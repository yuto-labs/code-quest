...
const pyExecute = [
  { id: 'br_py_e01', languageId: 'python', world: 'execute', title: 'Rio de Janeiro 2016 Olympics', titleJa: 'リオデジャネイロ2016年大会', category: 'sports-history', objective: 'function', source: SRC.rio2016, summaryJa: 'リオデジャネイロは2016年夏季オリンピックを開催しました。', prompt: '関数の戻り値を追跡し、出力を選んでください。', code: 'def host_label(city, year):\n    return f"{city}:{year}"\nprint(host_label("Rio de Janeiro", 2016))', options: ['Rio de Janeiro:2016', '2016:Rio de Janeiro', 'Rio:Olympics', 'Brazil:2016'], answer: 'Rio de Janeiro:2016', expectedOutput: 'Rio de Janeiro:2016', hint: 'return の f-string で city と year の順番を見ます。', explanation: 'city が先、year が後ろなので Rio de Janeiro:2016 です。', programmingExplanation: '関数呼び出しでは引数が仮引数に渡され、return の式が出力されます。', optionExplanations: { 'Rio de Janeiro:2016': '正解。f"{city}:{year}"はcityが先、yearが後なので、Rio de Janeiro:2016になります。', '2016:Rio de Janeiro': 'f文字列は{city}:{year}の順で定義されているため、cityが先になります。', 'Rio:Olympics': '渡された引数はそのまま使われ、"Rio"や"Olympics"のように省略・変更されることはありません。', 'Brazil:2016': '関数に渡されたcityの値は"Rio de Janeiro"で、国名"Brazil"が使われることはありません。' } },
  { id: 'br_py_e02', languageId: 'python', world: 'execute', title: 'Christ the Redeemer', titleJa: 'コルコバードのキリスト像', category: 'landmark', objective: 'dict', source: SRC.christ, summaryJa: 'コルコバードのキリスト像はリオデジャネイロに立つランドマークです。', prompt: '辞書 lookup の結果を選んでください。', code: 'landmark = {"name": "Christ the Redeemer", "city": "Rio de Janeiro"}\nprint(landmark["city"])', options: ['Rio de Janeiro', 'Christ the Redeemer', 'Brazil', 'city'], answer: 'Rio de Janeiro', expectedOutput: 'Rio de Janeiro', hint: '"city" キーの値を見ます。', explanation: 'landmark["city"] は Rio de Janeiro を返します。', programmingExplanation: '辞書のキーを指定すると対応する値だけを取り出せます。', optionExplanations: { 'Rio de Janeiro': '正解。landmark["city"]はcityキーに対応する値Rio de Janeiroを返します。', 'Christ the Redeemer': 'これはnameキーの値で、コードが参照しているのはcityキーです。', 'Brazil': 'landmarkにはcountryというキーは無く、Brazilという値は存在しません。', 'city': '"city"はキーの名前で、print()で出力されるのはそのキーに対応する値です。' } },
  { id: 'br_py_e03', languageId: 'python', world: 'execute', title: 'Sao Paulo Museum of Art', titleJa: 'サンパウロ美術館', category: 'museum-art', objective: 'loop', source: SRC.masp, summaryJa: 'MASP はサンパウロと結びつく美術館です。', prompt: 'リストを順に連結した出力を選んでください。', code: 'parts = ["MASP", "Sao Paulo"]\nlabel = ""\nfor part in parts:\n    label += part + "|"\nprint(label[:-1])', options: ['MASP|Sao Paulo', 'Sao Paulo|MASP', 'MASP|', 'Sao Paulo'], answer: 'MASP|Sao Paulo', expectedOutput: 'MASP|Sao Paulo', hint: 'parts の並び順と最後の | の削除を見ます。', explanation: 'MASP、Sao Paulo の順に追加され、最後の区切りだけ削られます。', programmingExplanation: 'for ループで文字列を累積し、スライス `[:-1]` で末尾1文字を除きます。', optionExplanations: { 'MASP|Sao Paulo': '正解。partsの順（MASP→Sao Paulo）に|区切りで追加され、末尾の|だけ取り除かれます。', 'Sao Paulo|MASP': 'forループはpartsの順（MASP→Sao Paulo）通りに処理するため、順序が逆になることはありません。', 'MASP|': '[:-1]は末尾の|だけを除くもので、Sao Paulo部分が消えることはありません。', 'Sao Paulo': 'partsの2要素は両方ループで処理されるため、MASPの部分が欠けることはありません。' } },
  { id: 'br_py_e04', languageId: 'python', world: 'execute', title: 'Pantanal wetlands', titleJa: 'パンタナル湿地', category: 'geography-nature', objective: 'loop', source: SRC.pantanal, summaryJa: 'パンタナルは世界最大級の熱帯湿地の一つとして知られます。', prompt: 'records を条件で絞った出力を選んでください。', code: 'records = [\n    {"name": "Pantanal", "type": "wetland"},\n    {"name": "Amazon", "type": "forest"}\n]\nselected = [r["name"] for r in records if r["type"] == "wetland"]\nprint(selected[0])', options: ['Pantanal', 'Amazon', 'wetland', 'forest'], answer: 'Pantanal', expectedOutput: 'Pantanal', hint: 'type が wetland の辞書だけ残します。', explanation: 'Pantanal の type だけが wetland なので選ばれます。', programmingExplanation: 'リスト内包表記は、条件に合う要素だけを新しいリストへ入れます。', optionExplanations: { 'Pantanal': '正解。typeが"wetland"なのはPantanalだけなので、selected[0]はPantanalになります。', 'Amazon': 'Amazonのtypeは"forest"で"wetland"ではないため、selectedには入りません。', 'wetland': '"wetland"はtypeキーの値（フィルタ条件）で、出力されるのはr["name"]の値です。', 'forest': 'forestはAmazonのtypeで条件に合わず除外され、出力にも使われません。' } },
];

const pyFinalExecute = [
  { id: 'final_execute_BR_python_01', languageId: 'python', world: 'execute', title: 'Serra da Capivara National Park', titleJa: 'セラ・ダ・カピバラ国立公園', category: 'world-heritage-archaeology', objective: 'loop', source: SRC.serraCapivara, summaryJa: 'セラ・ダ・カピバラ国立公園は考古遺跡と岩絵で知られます。', prompt: '記録を絞り、year の昇順に並べた出力を選んでください。', code: 'records = [\n    {"name": "rock art", "kind": "archaeology", "year": 1991},\n    {"name": "trail", "kind": "nature", "year": 2000},\n    {"name": "site", "kind": "archaeology", "year": 1989}\n]\nselected = sorted([r for r in records if r["kind"] == "archaeology"], key=lambda r: r["year"])\nprint(">".join(r["name"] for r in selected))', options: ['site>rock art', 'rock art>site', 'trail>site', 'rock art>trail'], answer: 'site>rock art', expectedOutput: 'site>rock art', hint: 'kind で絞ったあと year の昇順です。', explanation: 'archaeology は site(1989) と rock art(1991) で、昇順に site が先です。', programmingExplanation: 'フィルタリング、sorted の key、join を順番に追跡します。', optionExplanations: { 'site>rock art': '正解。kind=="archaeology"のsite(1989)とrock art(1991)をyear昇順にすると、site(1989)が先になります。', 'rock art>site': 'sortedはkey=yearで昇順なので、年が早いsite(1989)がrock art(1991)より先になります。', 'trail>site': 'trailはkind="nature"でarchaeologyの条件に合わず、リストに含まれません。', 'rock art>trail': 'trailはkind="nature"なのでフィルタで除外され、archaeologyのsiteとrock artだけが残ります。' } },
  { id: 'final_execute_BR_python_02', languageId: 'python', world: 'execute', title: 'Brazilian biomes dataset', titleJa: 'ブラジルのバイオーム', category: 'geography-nature', objective: 'dict', source: SRC.biomes, summaryJa: 'ブラジルにはAmazon、Cerrado、Caatinga、Atlantic Forest、Pantanal、Pampaなどの主要バイオームがあります。', prompt: '辞書とリストから protected が True の件数を集計した結果を選んでください。', code: 'biomes = [\n    {"name": "Amazon", "protected": True},\n    {"name": "Cerrado", "protected": True},\n    {"name": "Caatinga", "protected": False},\n    {"name": "Atlantic Forest", "protected": True},\n    {"name": "Pantanal", "protected": False},\n    {"name": "Pampa", "protected": False}\n]\ncount = sum(1 for biome in biomes if biome["protected"])\nprint(count)', options: ['3', '6', '2', 'Amazon'], answer: '3', expectedOutput: '3', hint: 'protected が True の辞書だけ数えます。', explanation: 'Amazon、Cerrado、Atlantic Forest の3件が True です。', programmingExplanation: '条件式を満たすたびに 1 を足し、sum で合計します。', optionExplanations: { '3': '正解。protected:TrueなのはAmazon、Cerrado、Atlantic Forestの3件です。', '6': 'biomesの全件数は6ですが、protected:Trueなのはそのうち3件だけです。', '2': 'protected:TrueなのはAmazon、Cerrado、Atlantic Forestの3件あり、2件ではありません。', 'Amazon': 'sumは件数（整数）を返すもので、要素の名前の文字列が出力されるわけではありません。' } },
];

const pyDebug = [
  { id: 'br_py_b01', languageId: 'python', world: 'debug', title: 'Carnival date labels', titleJa: 'カーニバルの日付ラベル', category: 'culture-festival', objective: 'loop', source: SRC.samba, summaryJa: 'ブラジルのカーニバルは音楽やパレードと結びつく大きな文化行事です。', prompt: '3つのイベントラベルをすべて表示したいコードです。境界条件の不具合を直します。', code: 'labels = ["opening", "parade", "final"]\nfor i in range(len(labels) + 1):\n    print(labels[i])', cause: 'range(len(labels) + 1) が存在しない添字まで進む', fix: 'range(len(labels)) に修正する', impact: '3つのラベルだけを範囲外エラーなしで表示できる', why: '最後の有効な添字は len(labels) - 1 だからです。', correctedCode: 'labels = ["opening", "parade", "final"]\nfor i in range(len(labels)):\n    print(labels[i])', hint: '最後の i が len(labels) になるか確認します。', explanation: 'len + 1 により範囲外アクセスが起きます。', programmingExplanation: 'range の終了値は含まれませんが、len + 1 だと len まで到達してしまいます。', causeOptionExplanations: { 'range(len(labels) + 1) が存在しない添字まで進む': '正解。labelsは3件なのでrange(4)は0〜3を生成し、labels[3]は存在せずIndexErrorになります。', '出力文の文字列だけが間違っている': 'print(labels[i])自体は正しく書けており、出力文の指定ミスではありません。', 'データ件数が不足している': 'labelsには3件のデータがあり、件数不足ではなくrangeの終了値が1つ多いことが原因です。' }, fixOptionExplanations: { 'range(len(labels)) に修正する': '正解。range(3)なら0,1,2だけを巡るので、存在する添字だけに安全にアクセスできます。', '対象データをすべて削除する': 'labelsを削除すると表示すべきデータ自体が無くなり、目的が果たせません。', '常に固定文字列を出力する': 'labelsの内容を無視して固定文字列を出すと、各イベント名を正しく表示できません。' }, impactOptionExplanations: { '3つのラベルだけを範囲外エラーなしで表示できる': '正解。range(len(labels))により、存在する3件の添字だけを安全に処理できます。', '例外を隠して処理を止める': '修正後はrangeの終了値が正しくなるため、IndexError自体が発生しなくなります。', 'テーマデータを使わなくなる': 'labelsのデータはそのまま使われ続けます。修正はrangeの範囲だけです。' } },
  { id: 'br_py_b02', languageId: 'python', world: 'debug', title: 'Brazilian real currency formatting', titleJa: 'ブラジルレアルの表示', category: 'finance', objective: 'format', source: SRC.real, summaryJa: 'ブラジルの通貨はレアルです。', prompt: '金額を R$10.50 と表示したいコードです。文字列と数値の扱いを直します。', code: 'amount = "10.5"\nprint("R$" + amount + 0)', cause: '文字列 amount に数値 0 を + で足している', fix: 'amount を float にして、f-string で小数2桁に整形する', impact: '数値計算と表示形式を分け、R$10.50 と安定して表示できる', why: '文字列連結と数値加算は別の処理だからです。', correctedCode: 'amount = 10.5\nprint(f"R${amount:.2f}")', hint: '表示用の小数桁は f-string の書式で指定します。', explanation: '文字列と数値をそのまま足すと TypeError になります。', programmingExplanation: 'f"{value:.2f}" は小数2桁の文字列を作ります。', causeOptionExplanations: { '文字列 amount に数値 0 を + で足している': '正解。amountは文字列"10.5"で、文字列に数値0を+で足すことはできずTypeErrorになります。', '出力文の文字列だけが間違っている': '"R$"の部分は正しく書けており、問題はamountと0の加算部分です。', 'データ件数が不足している': 'amountには値が1つ入っており、件数の問題ではなく型の不一致が原因です。' }, fixOptionExplanations: { 'amount を float にして、f-string で小数2桁に整形する': '正解。floatに変換しf"{amount:.2f}"とすることで、R$10.50のように整形できます。', '対象データをすべて削除する': 'amountを削除すると表示すべき金額自体が無くなり、目的が果たせません。', '常に固定文字列を出力する': '金額データを無視して固定文字列を出すと、実際の金額が反映されません。' }, impactOptionExplanations: { '数値計算と表示形式を分け、R$10.50 と安定して表示できる': '正解。floatとf-stringの書式指定により、計算と表示形式を分けて安定して表示できます。', '例外を隠して処理を止める': '修正後はamountがfloat型になるため、TypeError自体が発生しなくなります。', 'テーマデータを使わなくなる': 'amountのデータはそのまま使われ続けます。修正は型と表示形式だけです。' } },
  { id: 'br_py_b03', languageId: 'python', world: 'debug', title: 'Brazilian postal code format', titleJa: 'ブラジル郵便番号の形式', category: 'administration', objective: 'strings', source: SRC.postal, summaryJa: 'ブラジルの郵便番号は表示形式を保つため文字列として扱うのが安全です。', prompt: '先頭ゼロを含む可能性がある郵便番号を表示するコードです。数値保存の不具合を直します。', code: 'postal_code = 1234567\nprint(str(postal_code).zfill(8))', cause: '郵便番号を数値として保存すると先頭ゼロや区切りを保持できない', fix: '郵便番号を最初から文字列として保存する', impact: '先頭ゼロを含むコードも失わずに表示できる', why: '識別番号は計算対象ではなく、表記を保つ必要があるからです。', correctedCode: 'postal_code = "01234567"\nprint(postal_code)', hint: '計算しない番号は数値ではなく文字列が安全です。', explanation: '数値リテラルでは表記上の先頭ゼロを保持できません。', programmingExplanation: 'ID や郵便番号は arithmetic ではなく文字列データとして扱います。', causeOptionExplanations: { '郵便番号を数値として保存すると先頭ゼロや区切りを保持できない': '正解。1234567を整数として保存すると先頭ゼロの情報が失われ、zfill(8)で補っても元の8桁表記とは異なる場合があります。', '出力文の文字列だけが間違っている': 'print(str(postal_code).zfill(8))自体は正しく書けており、出力文の指定ミスではありません。', 'データ件数が不足している': 'postal_codeには値が1つ入っており、件数の問題ではなく数値型で保存していることが原因です。' }, fixOptionExplanations: { '郵便番号を最初から文字列として保存する': '正解。最初から文字列で保存すれば、先頭ゼロも含めて意図した表記をそのまま保持できます。', '対象データをすべて削除する': 'postal_codeを削除すると表示すべき郵便番号自体が無くなり、目的が果たせません。', '常に固定文字列を出力する': '実際の郵便番号データを無視して固定文字列を出すと、正しい番号が表示されません。' }, impactOptionExplanations: { '先頭ゼロを含むコードも失わずに表示できる': '正解。文字列として保存すれば、先頭ゼロを含む表記をそのまま失わずに表示できます。', '例外を隠して処理を止める': '文字列として保存する修正は例外処理とは無関係で、エラーを隠すものではありません。', 'テーマデータを使わなくなる': '郵便番号のデータ自体はそのまま使われ続けます。修正は保存する型だけです。' } },
];

const pyFinalDebug = [
  { id: 'final_debug_BR_python_01', languageId: 'python', world: 'debug', title: 'Chapada dos Veadeiros', titleJa: 'シャパーダ・ドス・ヴェアデイロス', category: 'world-heritage-nature', objective: 'dict', source: SRC.chapada, summaryJa: 'シャパーダ・ドス・ヴェアデイロス国立公園はゴイアス州にあります。', prompt: '面積データを数値化し、欠損を安全に扱いながら Goiás の公園だけを選ぶコードです。', code: 'parks = [{"name": "Chapada", "state": "Goias", "area": "2405"}, {"name": "Other", "state": "Goias"}]\nlarge = []\nfor park in parks:\n    if park["state"] == "Goias" and int(park["area"]) > 1000:\n        large.append(park["name"])\nprint(large)', cause: 'area がない辞書でも park["area"] を直接読んでいる', fix: 'park.get("area") を確認し、値がある場合だけ int に変換する', impact: '欠損行を安全に飛ばし、数値化できる公園だけを判定できる', why: 'get はキーがない場合に None を返せるため、変換前に確認できます。', correctedCode: 'parks = [{"name": "Chapada", "state": "Goias", "area": "2405"}, {"name": "Other", "state": "Goias"}]\nlarge = []\nfor park in parks:\n    area = park.get("area")\n    if park["state"] == "Goias" and area is not None and int(area) > 1000:\n        large.append(park["name"])\nprint(large)', hint: '2件目の辞書に area キーがありません。', explanation: '欠損キーを直接読むと KeyError になります。', programmingExplanation: 'get、None 判定、int 変換、複合条件を順に組み合わせます。', causeOptionExplanations: { 'area がない辞書でも park["area"] を直接読んでいる': '正解。"Other"の辞書にはareaキーが無く、park["area"]で直接読むとKeyErrorになります。', '出力文の文字列だけが間違っている': 'print(large)自体は正しく書けており、出力文の指定ミスではありません。', 'データ件数が不足している': 'parksには2件のデータがあり、件数不足ではなく"Other"にareaキーが無いことが原因です。' }, fixOptionExplanations: { 'park.get("area") を確認し、値がある場合だけ int に変換する': '正解。getはキーが無い場合Noneを返すので、None判定をしてから安全にint変換できます。', '対象データをすべて削除する': 'parksを削除すると判定すべき公園データ自体が無くなり、目的が果たせません。', '常に固定文字列を出力する': '実際の公園データを無視して固定文字列を出すと、正しい判定結果が得られません。' }, impactOptionExplanations: { '欠損行を安全に飛ばし、数値化できる公園だけを判定できる': '正解。Noneチェックにより、areaが無い行を安全にスキップして処理できます。', '例外を隠して処理を止める': '修正後はgetとNone判定があるため、KeyError自体が発生しなくなります。', 'テーマデータを使わなくなる': 'parksのデータはそのまま使われ続けます。修正はareaの読み取り方法だけです。' } },
];
...
const javaExecute = [
  { id: 'br_java_e01', languageId: 'java', world: 'execute', title: 'Santos Dumont', titleJa: 'サントス・デュモン', category: 'invention-science', objective: 'strings', source: SRC.santosDumont, summaryJa: 'アルベルト・サントス・デュモンはブラジルの航空の先駆者として知られます。', prompt: 'String.equals の比較結果を追跡し、出力を選んでください。', code: 'public class Main {\n  public static void main(String[] args) {\n    String pioneer = "Santos Dumont";\n    if (pioneer.equals("Santos Dumont")) System.out.println("aviation");\n    else System.out.println("other");\n  }\n}', options: ['aviation', 'other', 'Santos Dumont', 'true'], answer: 'aviation', expectedOutput: 'aviation', hint: 'equals の比較は true になります。', explanation: '文字列内容が一致するので aviation が出ます。', programmingExplanation: 'Java の String 内容比較には equals を使います。', optionExplanations: { 'aviation': '正解。pioneer.equals("Santos Dumont")がtrueなので最初のprintln("aviation")が実行されます。', 'other': '"other"はelse側の出力で、equalsがtrueの今回は実行されません。', 'Santos Dumont': 'pioneerの値そのものではなく、if/elseで選ばれた文字列が出力されます。', 'true': '比較結果のbooleanではなく、その結果で選ばれたprintlnの文字列が出力されます。' } },
  { id: 'br_java_e02', languageId: 'java', world: 'execute', title: 'Brazilian time zones', titleJa: 'ブラジルの時間帯', category: 'geography-time', objective: 'method', source: SRC.timeZones, summaryJa: 'ブラジルには複数のUTCオフセットの時間帯があります。', prompt: 'メソッド戻り値と足し算を追跡し、出力を選んでください。', code: 'public class Main {\n  static int localHour(int utcHour, int offset) { return utcHour + offset; }\n  public static void main(String[] args) {\n    System.out.println(localHour(15, -3));\n  }\n}', options: ['12', '18', '-3', '15'], answer: '12', expectedOutput: '12', hint: '15 + (-3) を計算します。', explanation: 'UTC 15 時に -3 を足すので 12 です。', programmingExplanation: 'int 引数を受け取り、return で計算結果を返します。', optionExplanations: { '12': '正解。localHour(15,-3)はutcHour+offsetを計算し、15+(-3)=12を返します。', '18': '15+(-3)は加算なので、15+3=18のように符号を逆にした計算にはなりません。', '-3': '-3はoffsetとして渡した引数の値で、返されるのはutcHourとoffsetを足した計算結果です。', '15': '15はutcHourの引数の値で、返されるのはoffsetを加えた後の計算結果です。' } },
  { id: 'br_java_e03', languageId: 'java', world: 'execute', title: 'Pelourinho district', titleJa: 'ペロウリーニョ地区', category: 'world-heritage-history', objective: 'collections', source: SRC.pelourinho, summaryJa: 'ペロウリーニョはサルヴァドールの歴史地区として知られます。', prompt: 'ArrayList を順に連結した出力を選んでください。', code: 'import java.util.ArrayList;\npublic class Main {\n  public static void main(String[] args) {\n    ArrayList<String> labels = new ArrayList<>();\n    labels.add("Pelourinho");\n    labels.add("Salvador");\n    String result = "";\n    for (String label : labels) result += label + ">";\n    System.out.println(result.substring(0, result.length() - 1));\n  }\n}', options: ['Pelourinho>Salvador', 'Salvador>Pelourinho', 'Pelourinho>', 'Salvador'], answer: 'Pelourinho>Salvador', expectedOutput: 'Pelourinho>Salvador', hint: '追加した順に result へ入ります。', explanation: 'Pelourinho、Salvador の順に追加され、最後の > を削ります。', programmingExplanation: 'ArrayList、拡張 for、文字列連結、substring を追跡します。', optionExplanations: { 'Pelourinho>Salvador': '正解。labelsの追加順（Pelourinho→Salvador）通りに連結され、末尾の>だけ取り除かれます。', 'Salvador>Pelourinho': '拡張forはlabelsの順（Pelourinho→Salvador）通りに処理するため、順序が逆になることはありません。', 'Pelourinho>': 'substringは末尾の>だけを除くもので、Salvador部分が消えることはありません。', 'Salvador': 'labelsの2要素は両方ループで処理されるため、Pelourinhoの部分が欠けることはありません。' } },
  { id: 'br_java_e04', languageId: 'java', world: 'execute', title: 'Indigenous languages in Brazil', titleJa: 'ブラジルの先住民言語', category: 'language-culture', objective: 'inheritance', source: SRC.languages, summaryJa: 'ブラジルには多様な先住民言語が存在します。', prompt: '継承とオーバーライドされたメソッド呼び出しの出力を選んでください。', code: 'class LanguageFamily { String label() { return "family"; } }\nclass TupiFamily extends LanguageFamily { @Override String label() { return "Tupi"; } }\npublic class Main {\n  public static void main(String[] args) {\n    LanguageFamily family = new TupiFamily();\n    System.out.println(family.label());\n  }\n}', options: ['Tupi', 'family', 'LanguageFamily', 'error'], answer: 'Tupi', expectedOutput: 'Tupi', hint: '実体は TupiFamily です。', explanation: '変数の型は親でも、実行時のオブジェクトの override が呼ばれます。', programmingExplanation: 'ポリモーフィズムにより、子クラスで上書きしたメソッドが実行されます。', optionExplanations: { 'Tupi': '正解。familyの実体はTupiFamilyなので、オーバーライドされたlabel()が呼ばれTupiが返ります。', 'family': '変数の型はLanguageFamilyですが、実行時には実体（TupiFamily）のoverrideされたメソッドが呼ばれます。', 'LanguageFamily': 'label()はクラス名ではなく文字列"family"または"Tupi"を返すメソッドです。', 'error': 'TupiFamilyはLanguageFamilyを正しく継承・オーバーライドしているため、コンパイルエラーや実行時エラーは起きません。' } },
];

const javaFinalExecute = [
  { id: 'final_execute_BR_java_01', languageId: 'java', world: 'execute', title: 'Coffee-producing states', titleJa: 'ブラジルのコーヒー生産州', category: 'industry-agriculture', objective: 'collections', source: SRC.coffeeStates, summaryJa: 'ブラジルでは複数の州がコーヒー生産と結びつきます。', prompt: 'HashMap とメソッドで high の州名を連結した出力を選んでください。', code: 'import java.util.HashMap;\npublic class Main {\n  static boolean high(int score) { return score >= 80; }\n  public static void main(String[] args) {\n    HashMap<String, Integer> states = new HashMap<>();\n    states.put("Minas Gerais", 90);\n    states.put("Bahia", 60);\n    String result = "";\n    for (String state : states.keySet()) if (high(states.get(state))) result += state;\n    System.out.println(result);\n  }\n}', options: ['Minas Gerais', 'Bahia', 'Minas GeraisBahia', '90'], answer: 'Minas Gerais', expectedOutput: 'Minas Gerais', hint: 'score が 80 以上の state だけです。', explanation: 'Minas Gerais の score だけが90で条件を満たします。', programmingExplanation: 'HashMap、keySet、メソッド戻り値、条件分岐を組み合わせます。', optionExplanations: { 'Minas Gerais': '正解。high(score)はscore>=80を判定し、Minas Gerais(90)だけがtrueでresultに追加されます。', 'Bahia': 'Bahiaのscoreは60でhigh(60)はfalseなので、resultには追加されません。', 'Minas GeraisBahia': 'high(60)はfalseでBahiaは条件を満たさないため、両方が連結されることはありません。', '90': '90はMinas Geraisのscoreの値で、出力されるのはhigh判定を通過したstate名です。' } },
  { id: 'final_execute_BR_java_02', languageId: 'java', world: 'execute', title: 'Amazon research station records', titleJa: 'アマゾン研究拠点レコード', category: 'science-geography', objective: 'class', source: SRC.amazon, summaryJa: 'アマゾン地域では森林や生物多様性を調べる研究拠点データを扱えます。', prompt: 'objects、ArrayList、condition、method output を追跡した出力を選んでください。', code: 'import java.util.ArrayList;\nclass Station { String name; boolean active; Station(String n, boolean a){ name=n; active=a; } String label(){ return name + ":active"; } }\npublic class Main {\n  public static void main(String[] args) {\n    ArrayList<Station> stations = new ArrayList<>();\n    stations.add(new Station("Manaus", true));\n    stations.add(new Station("Closed", false));\n    for (Station station : stations) if (station.active) System.out.println(station.label());\n  }\n}', options: ['Manaus:active', 'Closed:active', 'Manaus', 'active:Manaus'], answer: 'Manaus:active', expectedOutput: 'Manaus:active', hint: 'active が true の Station だけ label() を呼びます。', explanation: 'Manaus だけが active なので label() の結果が表示されます。', programmingExplanation: 'クラス、ArrayList、boolean フィールド、インスタンスメソッドをまとめて追跡します。', optionExplanations: { 'Manaus:active': '正解。Manausのactiveはtrueなのでif文を通過し、label()が"Manaus:active"を返します。', 'Closed:active': 'Closedのactiveはfalseなので、if (station.active)の条件を満たさずlabel()は呼ばれません。', 'Manaus': 'label()メソッドはname + ":active"を返すため、":active"部分も含めて出力されます。', 'active:Manaus': 'label()はname + ":active"の順で連結するため、nameが先、activeが後になります。' } },
];

const javaDebug = [
  { id: 'br_java_b01', languageId: 'java', world: 'debug', title: 'Brazilian state abbreviation lookup', titleJa: 'ブラジル州略号 lookup', category: 'administration', objective: 'strings', source: SRC.states, summaryJa: 'ブラジルの州略号は文字列コードとして扱います。', prompt: '州略号 SP を判定する Java コードです。String 比較の不具合を直します。', code: 'public class Main {\n  public static void main(String[] args) {\n    String code = new String("SP");\n    if (code == "SP") System.out.println("Sao Paulo");\n  }\n}', cause: 'String の内容比較に == を使っている', fix: 'code.equals("SP") に修正する', impact: '別オブジェクトの String でも内容が同じなら一致判定できる', why: '== は参照の同一性、equals は文字列内容を比較するためです。', correctedCode: 'public class Main {\n  public static void main(String[] args) {\n    String code = new String("SP");\n    if (code.equals("SP")) System.out.println("Sao Paulo");\n  }\n}', hint: 'Java の String は内容比較に equals を使います。', explanation: '== は同じオブジェクトかを見ます。', programmingExplanation: 'String comparison bug の基本です。', causeOptionExplanations: { 'String の内容比較に == を使っている': '正解。new String("SP")は新しい参照を作るため、==では文字列リテラルと参照が異なりfalseになります。', '出力文の文字列だけが間違っている': 'System.out.println自体は正しく書けており、出力文の指定ミスではありません。', 'データ件数が不足している': 'codeには"SP"という値が入っており、件数不足ではなく比較方法が原因です。' }, fixOptionExplanations: { 'code.equals("SP") に修正する': '正解。equalsは文字列の内容を比較するため、参照が違っても中身が同じならtrueになります。', '対象データをすべて削除する': 'codeを削除すると比較すべき値自体が無くなり、目的が果たせません。', '常に固定文字列を出力する': '実際のcodeの値を無視して固定文字列を出すと、正しい判定にはなりません。' }, impactOptionExplanations: { '別オブジェクトの String でも内容が同じなら一致判定できる': '正解。equalsを使うことで、参照に関わらず文字列の内容で正しく判定できます。', '例外を隠して処理を止める': 'equalsへの変更で例外が発生するようになるわけではなく、正しくtrue/falseが返ります。', 'テーマデータを使わなくなる': 'codeのデータはそのまま使われ続けます。修正は比較方法だけです。' } },
  { id: 'br_java_b02', languageId: 'java', world: 'debug', title: 'CPF-like numeric string formatting', titleJa: 'CPF風の数値文字列形式', category: 'administration-formatting', objective: 'strings', source: SRC.postal, summaryJa: '個人情報ではないサンプルの番号形式は、先頭ゼロを保つため文字列として扱います。', prompt: 'サンプル番号 01234567890 を保持したいコードです。数値保存の不具合を直します。', code: 'public class Main {\n  public static void main(String[] args) {\n    long sample = 01234567890L;\n    System.out.println(sample);\n  }\n}', cause: '先頭ゼロを含む識別番号を数値として保存している', fix: 'String sample = "01234567890"; として保存する', impact: '先頭ゼロを失わず、表示形式をそのまま保てる', why: '識別番号は計算対象ではなく表記を保つデータだからです。', correctedCode: 'public class Main {\n  public static void main(String[] args) {\n    String sample = "01234567890";\n    System.out.println(sample);\n  }\n}', hint: '計算しない番号は String が安全です。', explanation: '数値型では表記上の先頭ゼロを保持できません。', programmingExplanation: 'ID や番号形式は numeric type ではなく String として扱います。', causeOptionExplanations: { '先頭ゼロを含む識別番号を数値として保存している': '正解。01234567890Lのようなlong型では先頭ゼロの表記が保持されず、出力時に失われます。', '出力文の文字列だけが間違っている': 'System.out.println自体は正しく書けており、出力文の指定ミスではありません。', 'データ件数が不足している': 'sampleには値が1つ入っており、件数の問題ではなく数値型で保存していることが原因です。' }, fixOptionExplanations: { 'String sample = "01234567890"; として保存する': '正解。最初から文字列で保存すれば、先頭ゼロも含めて意図した表記をそのまま保持できます。', '対象データをすべて削除する': 'sampleを削除すると表示すべき番号自体が無くなり、目的が果たせません。', '常に固定文字列を出力する': '実際の番号データを無視して固定文字列を出すと、正しい番号が表示されません。' }, impactOptionExplanations: { '先頭ゼロを失わず、表示形式をそのまま保てる': '正解。文字列として保存すれば、先頭ゼロを含む表記をそのまま失わずに表示できます。', '例外を隠して処理を止める': '文字列として保存する修正は例外処理とは無関係で、エラーを隠すものではありません。', 'テーマデータを使わなくなる': '番号のデータ自体はそのまま使われ続けます。修正は保存する型だけです。' } },
  { id: 'br_java_b03', languageId: 'java', world: 'debug', title: 'Carnival score average', titleJa: 'カーニバル採点平均', category: 'culture-festival', objective: 'numbers', source: SRC.samba, summaryJa: 'カーニバルの採点データは平均計算の題材として扱えます。', prompt: '9点と10点の平均 9.5 を出したいコードです。整数除算の不具合を直します。', code: 'public class Main {\n  public static void main(String[] args) {\n    int total = 19;\n    int judges = 2;\n    double average = total / judges;\n    System.out.println(average);\n  }\n}', cause: 'int 同士の割り算なので小数部が切り捨てられる', fix: 'total または judges を double に変換してから割る', impact: '9.5 のような小数平均を正しく表せる', why: 'Java は int / int を整数除算として計算するからです。', correctedCode: 'public class Main {\n  public static void main(String[] args) {\n    int total = 19;\n    int judges = 2;\n    double average = (double) total / judges;\n    System.out.println(average);\n  }\n}', hint: '割り算の前に片方を double にします。', explanation: 'int / int は 9 になってから double に入ります。', programmingExplanation: 'キャストにより小数を含む割り算へ変えます。', causeOptionExplanations: { 'int 同士の割り算なので小数部が切り捨てられる': '正解。total/judgesはint同士の演算なので19/2は9に切り捨てられ、その後doubleに入ります。', '出力文の文字列だけが間違っている': 'System.out.println自体は正しく書けており、出力文の指定ミスではありません。', 'データ件数が不足している': 'totalとjudgesには値が入っており、件数の問題ではなく整数除算が原因です。' }, fixOptionExplanations: { 'total または judges を double に変換してから割る': '正解。片方をdoubleにキャストすれば、計算自体が小数を含む除算になり9.5が得られます。', '対象データをすべて削除する': 'totalやjudgesを削除すると平均を計算するデータ自体が無くなり、目的が果たせません。', '常に固定文字列を出力する': '実際の採点データを無視して固定文字列を出すと、正しい平均が表示されません。' }, impactOptionExplanations: { '9.5 のような小数平均を正しく表せる': '正解。キャストにより除算自体が小数を含むようになり、9.5のような正しい平均を表せます。', '例外を隠して処理を止める': 'この修正はキャストを加えるだけで、例外処理とは無関係です。', 'テーマデータを使わなくなる': 'totalとjudgesのデータはそのまま使われ続けます。修正は計算方法だけです。' } },
];

const javaFinalDebug = [
  { id: 'final_debug_BR_java_01', languageId: 'java', world: 'debug', title: 'Lencois Maranhenses National Park', titleJa: 'レンソイス・マラニャンセス国立公園', category: 'geography-nature', objective: 'collections', source: SRC.lencois, summaryJa: 'レンソイス・マラニャンセス国立公園はマラニョン州にあります。', prompt: 'HashMap の欠損値を確認し、数値変換を安全に行う Java コードへ直します。', code: 'import java.util.HashMap;\npublic class Main {\n  public static void main(String[] args) {\n    HashMap<String, String> areas = new HashMap<>();\n    areas.put("Lencois Maranhenses", "1550");\n    String areaText = areas.get("Other Park");\n    int area = Integer.parseInt(areaText);\n    System.out.println(area);\n  }\n}', cause: '存在しないキーを get して null を parseInt に渡している', fix: 'get した値が null でないか確認し、try/catch で変換失敗にも備える', impact: '欠損キーや不正な数値文字列でも処理が落ちず、安全に分岐できる', causeOptionExplanations: { '存在しないキーを get して null を parseInt に渡している': '正解。areasに"Other Park"キーは無くgetはnullを返し、Integer.parseInt(null)はNullPointerExceptionになります。', '出力文の文字列だけが間違っている': 'System.out.println自体は正しく書けており、出力文の指定ミスではありません。', 'データ件数が不足している': 'areasには1件のデータがあり、件数の問題ではなく存在しないキーを参照していることが原因です。' }, fixOptionExplanations: { 'get した値が null でないか確認し、try/catch で変換失敗にも備える': '正解。nullチェックとtry/catchにより、欠損キーや不正な文字列でも安全に処理できます。', '対象データをすべて削除する': 'areasを削除すると変換すべき面積データ自体が無くなり、目的が果たせません。', '常に固定文字列を出力する': '実際の面積データを無視して固定文字列を出すと、正しい数値が表示されません。' }, impactOptionExplanations: { '欠損キーや不正な数値文字列でも処理が落ちず、安全に分岐できる': '正解。nullチェックとtry/catchにより、欠損や不正な値があっても安全に分岐して処理を続けられます。', '例外を隠して処理を止める': '修正後はtry/catchで例外を捕捉して処理を続けるため、エラーで停止することはありません。', 'テーマデータを使わなくなる': 'areasのデータはそのまま使われ続けます。修正は値の確認方法だけです。' }, why: 'HashMap.get はキーがないと null を返し、parseInt は null や不正文字列を処理できないためです。', correctedCode: 'import java.util.HashMap;\npublic class Main {\n  public static void main(String[] args) {\n    HashMap<String, String> areas = new HashMap<>();\n    areas.put("Lencois Maranhenses", "1550");\n    String areaText = areas.get("Lencois Maranhenses");\n    try {\n      if (areaText != null) System.out.println(Integer.parseInt(areaText));\n      else System.out.println("unknown");\n    } catch (NumberFormatException e) {\n      System.out.println("invalid");\n    }\n  }\n}', hint: 'get の戻り値が null かもしれない点を見ます。', explanation: 'null を Integer.parseInt に渡すと安全に処理できません。', programmingExplanation: 'HashMap、null check、Integer.parseInt、try/catch を組み合わせて安全に変換します。' },
];
