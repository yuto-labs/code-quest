  ...
  "US": [
    {
      ...
      "description": "アメリカ下院の議席数を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
      "expectedOutput": "435",
    ...
    },
    {
      ...
      "description": "連邦政府と州政府を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
    ...
    },
    {
      ...
      "description": "自由の女神とフランスを題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
      "expectedOutput": "true",
    ...
    },
    {
      ...
      "description": "自由の鐘を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
      "expectedOutput": "true",
    ...
    },
    {
      ...
      "description": "ヨセミテ国立公園を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
      "expectedOutput": "Yosemite",
    ...
    },
    {
      ...
      "description": "メサ・ヴェルデを題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
      "expectedOutput": "true",
    ...
    },
    {
      ...
      "description": "ジョージ・ワシントン初代大統領を題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
      "expectedOutput": "George Washington: 1789",
    ...
    },
    {
      ...
      "description": "アーネスト・ヘミングウェイを題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
      "expectedOutput": "Ernest Hemingway",
    ...
    },
    {
      ...
      "description": "デナリを題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
      "expectedOutput": "20310",
    ...
    },
    {
      ...
      "description": "ゴールデンゲートブリッジを題材に、実行結果が下に表示されるよう、空欄を埋めてください。",
      "expectedOutput": "1937",
