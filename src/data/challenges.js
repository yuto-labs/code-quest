    ...
    "python": [
      {
        ...
        "description": "three federal branches/checks-balances の公式データを使い、dict-access の空欄を補います。",
      ...
      },
      {
        ...
        "description": "United States Senate composition の公式データを使い、list-length/numeric の空欄を補います。",
      ...
      },
      {
        ...
        "description": "United States flag stars/stripes の公式データを使い、dict-access の空欄を補います。",
      ...
      },
      {
        ...
        "description": "bald eagle national symbol の公式データを使い、membership/boolean の空欄を補います。",
      ...
      },
      {
        ...
        "description": "Yellowstone establishment/first-national-park scope の公式データを使い、tuple-unpack の空欄を補います。",
      ...
      },
      {
        ...
        "description": "Independence Hall founding documents の公式データを使い、list-index の空欄を補います。",
      ...
      },
      {
        ...
        "description": "Apollo 11 mission and crew の公式データを使い、f-string の空欄を補います。",
      ...
      },
      {
        ...
        "description": "Mark Twain/Huckleberry Finn の公式データを使い、string/dict の空欄を補います。",
      ...
      },
      {
        ...
        "description": "Mississippi River geography の公式データを使い、numeric-comparison の空欄を補います。",
      ...
      },
      {
        ...
        "description": "Route 66 establishment/route の公式データを使い、string-slice の空欄を補います。",
