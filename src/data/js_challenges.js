  ...
  "JP": [
    {
      ...
      "description": "君が代を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
    ...
    },
    {
      ...
      "description": "青色LEDとノーベル賞を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の直前がドットならプロパティ名、角かっこなら添字を入れます。",
    ...
    },
    {
      ...
      "description": "吉野彰とリチウムイオン電池を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の直前がドットならプロパティ名、角かっこなら添字を入れます。",
    ...
    },
    {
      ...
      "description": "山中伸弥とiPS細胞を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の直前がドットならプロパティ名、角かっこなら添字を入れます。",
    ...
    },
    {
      ...
      "description": "姫路城と白鷺城を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の直前がドットならプロパティ名、角かっこなら添字を入れます。",
    ...
    },
    {
      ...
      "description": "富士山を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の直前がドットならプロパティ名、角かっこなら添字を入れます。",
    ...
    },
    {
      ...
      "description": "フランシスコ・ザビエル来日を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の直前がドットならプロパティ名、角かっこなら添字を入れます。",
    ...
    },
    {
      ...
      "description": "ウィリアム・アダムス来航を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の直前がドットならプロパティ名、角かっこなら添字を入れます。",
    ...
    },
    {
      ...
      "description": "紫式部と源氏物語を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の直前がドットならプロパティ名、角かっこなら添字を入れます。",
    ...
    },
    {
      ...
      "description": "歌舞伎を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の直前がドットならプロパティ名、角かっこなら添字を入れます。",
  ...
  "US": [
    {
      ...
      "conceptId": "objects",
      "questionType": "fill-blank",
      "title": "House of Representatives composition: DECODE",
      "description": "アメリカ下院の議席数を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく seats の形で式を完成させます。",
      "code": "const house = { seats: 435, chamber: \"House\" };\nconsole.log(house.___BLANK___);",
      "blank": "seats",
      "explanation": "seats を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": "seats",
      "completedCode": "const house = { seats: 435, chamber: \"House\" };\nconsole.log(house.seats);",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に seats を入れる。",
        "最後の出力を確認する。"
    ...
    },
    {
      ...
      "conceptId": "objects",
      "questionType": "fill-blank",
      "title": "federal/state government structure: DECODE",
      "description": "連邦政府と州政府を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく state.level の形で式を完成させます。",
      "code": "const government = { federal: { level: \"national\" }, state: { level: \"state\" } };\nconsole.log(government.___BLANK___);",
      "blank": "state.level",
      "explanation": "state.level を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": "state.level",
      "completedCode": "const government = { federal: { level: \"national\" }, state: { level: \"state\" } };\nconsole.log(government.state.level);",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に state.level を入れる。",
        "最後の出力を確認する。"
      ],
      "commonMistakes": [
    ...
    },
    {
      ...
      "conceptId": "arrays",
      "questionType": "fill-blank",
      "title": "Statue of Liberty/France connection: DECODE",
      "description": "自由の女神とフランスを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく partner === \"France\" の形で式を完成させます。",
      "code": "const partner = \"France\";\nconsole.log(___BLANK___);",
      "blank": "partner === \"France\"",
      "explanation": "partner === \"France\" を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": "partner === \"France\"",
      "completedCode": "const partner = \"France\";\nconsole.log(partner === \"France\");",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に partner === \"France\" を入れる。",
        "最後の出力を確認する。"
      ],
      "commonMistakes": [
    ...
    },
    {
      ...
      "conceptId": "functions",
      "questionType": "fill-blank",
      "title": "Liberty Bell inscription/symbolism: DECODE",
      "description": "自由の鐘を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく includes(\"Proclaim Liberty\") の形で式を完成させます。",
      "code": "const inscription = \"Proclaim Liberty Throughout All the Land\";\nconsole.log(inscription.___BLANK___);",
      "blank": "includes(\"Proclaim Liberty\")",
      "explanation": "includes(\"Proclaim Liberty\") を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": "includes(\"Proclaim Liberty\")",
      "completedCode": "const inscription = \"Proclaim Liberty Throughout All the Land\";\nconsole.log(inscription.includes(\"Proclaim Liberty\"));",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に includes(\"Proclaim Liberty\") を入れる。",
        "最後の出力を確認する。"
      ],
      "commonMistakes": [
    ...
    },
    {
      ...
      "conceptId": "arrays",
      "questionType": "fill-blank",
      "title": "Yosemite World Heritage: DECODE",
      "description": "ヨセミテ国立公園を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく 0 の形で式を完成させます。",
      "code": "const sites = [\"Yosemite\", \"Mesa Verde\", \"Chaco Culture\"];\nconsole.log(sites[___BLANK___]);",
      "blank": "0",
      "explanation": "0 を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": "0",
      "completedCode": "const sites = [\"Yosemite\", \"Mesa Verde\", \"Chaco Culture\"];\nconsole.log(sites[0]);",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に 0 を入れる。",
        "最後の出力を確認する。"
    ...
    },
    {
      ...
      "conceptId": "objects",
      "questionType": "fill-blank",
      "title": "Mesa Verde cliff dwellings: DECODE",
      "description": "メサ・ヴェルデを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく >= の形で式を完成させます。",
      "code": "const dwellings = 600;\nconsole.log(dwellings ___BLANK___ 500);",
      "blank": ">=",
      "explanation": ">= を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": ">=",
      "completedCode": "const dwellings = 600;\nconsole.log(dwellings >= 500);",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に >= を入れる。",
        "最後の出力を確認する。"
    ...
    },
    {
      ...
      "conceptId": "arrays",
      "questionType": "fill-blank",
      "title": "George Washington first presidency context: DECODE",
      "description": "ジョージ・ワシントン初代大統領を題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく `${president}: ${year}` の形で式を完成させます。",
      "code": "const president = \"George Washington\";\nconst year = 1789;\nconsole.log(___BLANK___);",
      "blank": "`${president}: ${year}`",
      "explanation": "`${president}: ${year}` を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": "`${president}: ${year}`",
      "completedCode": "const president = \"George Washington\";\nconst year = 1789;\nconsole.log(`${president}: ${year}`);",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に `${president}: ${year}` を入れる。",
        "最後の出力を確認する。"
      ],
      "commonMistakes": [
    ...
    },
    {
      ...
      "conceptId": "objects",
      "questionType": "fill-blank",
      "title": "Ernest Hemingway Nobel Literature: DECODE",
      "description": "アーネスト・ヘミングウェイを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく author の形で式を完成させます。",
      "code": "const writer = { author: \"Ernest Hemingway\", prize: \"Literature\" };\nconst { ___BLANK___ } = writer;\nconsole.log(author);",
      "blank": "author",
      "explanation": "author を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": "author",
      "completedCode": "const writer = { author: \"Ernest Hemingway\", prize: \"Literature\" };\nconst { author } = writer;\nconsole.log(author);",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に author を入れる。",
        "最後の出力を確認する。"
    ...
    },
    {
      ...
      "conceptId": "variables",
      "questionType": "fill-blank",
      "title": "Denali geographic elevation context: DECODE",
      "description": "デナリを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく Math.max(...peaks) の形で式を完成させます。",
      "code": "const peaks = [20310, 14411, 14505];\nconsole.log(___BLANK___);",
      "blank": "Math.max(...peaks)",
      "explanation": "Math.max(...peaks) を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": "Math.max(...peaks)",
      "completedCode": "const peaks = [20310, 14411, 14505];\nconsole.log(Math.max(...peaks));",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に Math.max(...peaks) を入れる。",
        "最後の出力を確認する。"
      ],
      "commonMistakes": [
    ...
    },
    {
      ...
      "conceptId": "objects",
      "questionType": "fill-blank",
      "title": "Golden Gate Bridge data: DECODE",
      "description": "ゴールデンゲートブリッジを題材に、下記のコードを実行したときにテーマと一致する結果が表示されるよう、空欄を埋めてください。",
      "hint": "空欄の前後を見て、値ではなく Object.values(bridge)[1] の形で式を完成させます。",
      "code": "const bridge = { name: \"Golden Gate Bridge\", opened: 1937, city: \"San Francisco\" };\nconsole.log(___BLANK___);",
      "blank": "Object.values(bridge)[1]",
      "explanation": "Object.values(bridge)[1] を入れると、コード内の米国データから目的の値を作れます。",
      "correctAnswer": "Object.values(bridge)[1]",
      "completedCode": "const bridge = { name: \"Golden Gate Bridge\", opened: 1937, city: \"San Francisco\" };\nconsole.log(Object.values(bridge)[1]);",
      "executionSteps": [
        "コード内の米国データを読む。",
        "空欄に Object.values(bridge)[1] を入れる。",
        "最後の出力を確認する。"
      ],
      "commonMistakes": [
